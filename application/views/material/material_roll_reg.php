                                        ...
                                        <div class="">
                                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                                <input type="text" placeholder="Full Name" name="name" id="name"
                                                       class="required" value="<?= $full_name ?>">
                                            </label>
                                        </div>
                                        <div class="">
    ...
    <script>
        ...
        $(document).on("change", "#woundoption", function (e) {
            ...
            if (val != '') {
                ...
                imgError(this);
                ' src="<?=Assets?>images/loader.gif" width="139" height="29" class="image" style="width:139px; height:29px; ">'
            )
                ;
                    ...
                    success: function (data) {
                        ...
                        if (val == 'Inside') {
                            ...
                            setTimeout(function () {
                                ...
                                $('#prod_img').html('<img onerror='
                                imgError(this);
                                ' id="wound_image" src="<?=Assets?>images/categoryimages/RollLabels/inside/<?=ltrim($details['DieCode'], "1-")?>' + material_code + '.jpg">'
                            )
                                ;
                            ...
                            setTimeout(function () {
								...
								*/
                                ...
                                $('#prod_img').html('<img onerror='
                                imgError(this);
                                ' id="wound_image" src ="<?=Assets?>images/categoryimages/RollLabels/outside/<?=ltrim($details['DieCode'], "1-")?>' + material_code + '.jpg">'
                            )
                                ;
