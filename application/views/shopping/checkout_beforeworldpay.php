                                        ...
                                        <div class="m-t-15">
                                             ...
                                             <input type="password" placeholder="Enter Password" name="password" id="password" class="required">
                                                ...
                                                <div class=" ">
                                                    ...
                                                    <a class="TextGray" href="<?=base_url()?>users/forgotPassword">Forgot Your Password ?</a> </label>
                                                </div>
                                                <div>
                    ...
                    <div class="m-t-15">
                      <div class="p-l-r-10">
                          ...
                          <div class="">
                                         ...
                                         <a href="<?=base_url()?>transactionRegistration.php?checkout=guest" class="btn orange text-uppercase m-t-30">
	...
	$(document).ready(function() {
      ...
      <div id="validation_errors" role="alert" class="alert alert-danger alert-dismissible fade in">
          <button aria-label="Close" data-dismiss="alert" class="close" type="button"><span aria-hidden="true">×</span></button>
          	<strong>Validation error! </strong> Please fix following fields.<br />
          	<?=$error?>
      </div>
		...
		<form  method="post" id="checkout_form" class="labels-form " action="">
             ...
             <b class="tooltip tooltip-bottom-right">Please Enter Phone Number</b>                           
                          ...
                          <div class="col-sm-12 " >
                                  <label class="input">
                                     <!--   <a style="color:#fd4913;" href="javascript:void(0);" id="BillingsearchButton11" class="icon-append fa fa-search"></a>-->
                                        ...
                                        <input type="text" placeholder="Postcode" value="<?=$billing_pcode?>"  name="b_pcode" id="b_pcode" class="">
                                  ...
                                  <div class="col-sm-12 " >
                                    <label class="input">
                                        ...
                                        <input type="text" placeholder="Address 1" value="<?=$billing_add1?>"  name="b_add1"  id="b_add1" 	 class="required"> 
                     <b class="tooltip tooltip-bottom-right">Please Enter Address Line</b>                   
                                  ...
                                  <div class="col-sm-12 " >
                                    <label class="input">
                                        <i class="icon-append fa fa-envelope-o"></i>
                                        <input type="text" placeholder="Address 2" value="<?=$billing_add2?>"  name="b_add2" id="b_add2">
                            <b class="tooltip tooltip-bottom-right">Please Enter Address Line</b>            
                                    </label>
                                </div>
                                  ...
                                  <div class="col-sm-12 " >
                                    <label class="input">
                                        ...
                                        <input type="text" placeholder="City/Town" value="<?=$billing_city?>"  name="b_city" id="b_city" class="required"> <b class="tooltip tooltip-bottom-right">Please Enter City or Town</b>
                                  ...
                                  <div class="col-sm-12 " >
                                    <label class="input">
                                        <i class="icon-append fa fa-map-marker"></i>
                                        <input type="text" placeholder="County " value="<?=$billing_county?>"  name="b_county" id="b_county" class="required">
                        ...
                        <div class="col-sm-4">
                              ...
                              <label class="select">
                                    <select name="country" id="country" class="required">
                                     ...
                                     <option <?=($country=='United Kingdom')?'selected="selected"':''?>  value="United Kingdom">United Kingdom</option>
                                     <option <?=($country=='Ireland')?'selected="selected"':''?> value="Ireland">Ireland</option>
                                     <option <?=($country=='Belgium')?'selected="selected"':''?> value="Belgium">Belgium</option>
                                     <option <?=($country=='Denmark')?'selected="selected"':''?> value="Denmark">Denmark</option>
                                     <option <?=($country=='France')?'selected="selected"':''?> value="France">France</option>
                                     <option <?=($country=='Holland')?'selected="selected"':''?> value="Holland">Holland</option>
                                     <option <?=($country=='Germany')?'selected="selected"':''?> value="Germany">Germany</option>
                                     <option <?=($country=='Luxembourg')?'selected="selected"':''?> value="Luxembourg">Luxembourg</option>
                                     <option <?=($country=='Sweden')?'selected="selected"':''?> value="Sweden">Sweden</option>
                                     <option <?=($country=='Spain')?'selected="selected"':''?> value="Spain">Spain</option>
                                     <option <?=($country=='Switzerland')?'selected="selected"':''?> value="Switzerland">Switzerland</option>
                                    </select>
                                   <i></i>
                                </label>
                             </div>
                                  ...
                                  <div class="col-sm-12 " >
                                   <label class="select">
                                         <select name="b_ResCom" id="b_ResCom" class="required">
                                            ...
                                            <option <? if($res_b=='1') {echo 'selected="selected"';}?>  value="1">Residential</option>
                                            <option <? if($res_b=='2') {echo 'selected="selected"';}?>  value="2">Commercial</option>
                                        </select>
                                        <i></i>
                                    </label>
                                </div>
                               ...
                               <div class="col-sm-12 " >
								...
								if($show_newsletter=='Yes'){?>
                                 ...
                                 <div class="col-sm-12 " >
                                    ...
                                    <i></i>I'd like to be contacted with the latest news, offers and discount voucher from AA Labels. </label>
                                </div>
                 ...
                 <div class="setup-content" id="step-2">
                       ...
                       <div class="">
                        ...
                        <div class="col-sm-4">
                                ...
                                <label class="input">
                                    <i class="icon-append fa fa-user"></i>
                                    <input type="text" placeholder="First Name" id="d_first_name" name="d_first_name" value="<?=$delivery_fname?>"  class="required">
                         ...
                         <div class="col-sm-12 " >
                                  <label class="input">
                                       ...
                                       <!-- <a style="color: #fd4913;" href="javascript:void(0);" id="DeliverysearchButton" class="icon-append fa fa-search"></a>-->
                                              <input type="text" placeholder="Postcode" name="d_pcode" value="<?=$delivery_pcode?>" id="d_pcode" class="">
                                        <b  class="tooltip tooltip-bottom-right">Please Enter Postcode</b>
                                    </label>
                          ...
                          <!--<div class="col-sm-12 " >
                                  ...
                                  <div class="col-sm-12 " >
                                    <label class="input">
                                        <i class="icon-append fa fa-envelope-o"></i>
                                        <input type="text" placeholder="Address 1" name="d_add1" value="<?=$delivery_add1?>"  id="d_add1" 	 class="required"><b class="tooltip tooltip-bottom-right">Please Enter Address Line</b>             
                                  ...
                                  <div class="col-sm-12 " >
                                    <label class="input">
                                        <i class="icon-append fa fa-envelope-o"></i>
                                        <input type="text" placeholder="Address 2" value="<?=$delivery_add2?>"  name="d_add2" id="d_add2">
                                        <b class="tooltip tooltip-bottom-right">Please Enter Address Line</b>             
                                    </label>
                                </div>
                                  ...
                                  <div class="col-sm-12 " >
                                    <label class="input">
                                        <i class="icon-append fa fa-map-marker"></i>
                                        <input type="text" placeholder="City/Town" value="<?=$delivery_city?>"  name="d_city" id="d_city" class="required">
           <b class="tooltip tooltip-bottom-right">Please Enter City or Town</b>                                          
                                  ...
                                  <div class="col-sm-12 " >
                                    <label class="input">
                                        <i class="icon-append fa fa-map-marker"></i>
                                        <input type="text" placeholder="County " value="<?=$delivery_county?>"  name="d_county" id="d_county" class="required">
                        <b class="tooltip tooltip-bottom-right">Please Enter County</b>                             
                                    </label>
                                </div>
                  ...
                  <select name="dcountry" id="dcountry" class="required" >
                          <option data-value="GB" <?=($dcountry=='United Kingdom')?'selected="selected"':''?>  value="United Kingdom">United Kingdom</option>	
                          <option data-value="IE" <?=($dcountry=='Ireland')?'selected="selected"':''?> value="Ireland">Ireland</option>
                          <option data-value="BE" <?=($dcountry=='Belgium')?'selected="selected"':''?> value="Belgium">Belgium</option>
                          <option data-value="DK" <?=($dcountry=='Denmark')?'selected="selected"':''?> value="Denmark">Denmark</option>
                          <option data-value="FR" <?=($dcountry=='France')?'selected="selected"':''?> value="France">France</option>
                          <option data-value="NL" <?=($dcountry=='Holland')?'selected="selected"':''?> value="Holland">Holland</option>
                          <option data-value="DE" <?=($dcountry=='Germany')?'selected="selected"':''?> value="Germany">Germany</option>
                          <option data-value="LU" <?=($dcountry=='Luxembourg')?'selected="selected"':''?> value="Luxembourg">Luxembourg</option>
                          <option data-value="SE" <?=($dcountry=='Sweden')?'selected="selected"':''?> value="Sweden">Sweden</option>
                          <option data-value="ES" <?=($dcountry=='Spain')?'selected="selected"':''?>  value="Spain">Spain</option>
                          <option data-value="CH" <?=($dcountry=='Switzerland')?'selected="selected"':''?> value="Switzerland">Switzerland</option>
                      </select>
                                      <i></i>
                                    </label>
                            		</div>
                                  ...
                                  <div class="col-sm-12 " >
                                   <label class="select">
                                        <select name="d_ResCom" id="d_ResCom" class="required">
                                             <option value="" >Resi/Com </option>
                                             <option <? if($res_d=='1'){ echo 'selected="selected"';}?>  value="1">Residential</option>
                                             <option <? if($res_d=='2'){ echo 'selected="selected"';}?> value="2">Commercial</option>
                                        </select>
                                        <i></i>
                                    </label>
                                </div>
              	 ...
              	 <div class="setup-content" id="step-3">
                    ...
                    <div class="input-group"> <span id="vat_cc" class="input-group-addon">&nbsp;</span> 
                     <input type="text" id="vatnumber" name="vatnumber" placeholder="Enter VAT number" class="form-control"> 
                     </div>
                     ...
                     Orders placed before 16:00 qualify for next day delivery, providing this is not a weekend or public holiday. 
                     Orders placed after 16:00 will be treated as having been received the day after placement in production terms and the 
                     next working day will be calculated accordingly. For Saturday delivery orders must also be placed before 16:00 on 
                   ...
                   <div >
                      ...
                      charge of &pound;11.75 plus VAT. Postcodes which classify as exception postcodes on mainland UK are decided by our couriers.
                      <br /></p>
              ...
              <div class="col-sm-6">
                 <div>
                   ...
                   <p class="m-t-10"><label class="radio borderRadius ">
                       <input type="radio" class="" id="paypal" value="paypal"  name="paymentway"> <i class="rounded-x m-l-10"></i>&nbsp; <strong>
                       Pay by PayPal or Credit / Debit Card </strong></label>
                   </p>
...
<small> (Government Offices &amp; Educational Organisations only)
</small>  
                            </label>
                            </p>
                            <p class="m-t-10">
                            	<small> Please note that your order will not be processed until we receive a signed copy of your official Purchase Order via post to: AA Labels, 23 Wainman Road, Peterborough PE2 7BU or email: <a href="mailto:customercare@aalabels.com">customercare@aalabels.com</a>
</small>
                            </p>
                      </div>
           ...
           <div class="col-sm-12 ">
                    <div class="col-sm-6">
                    	<p class="m-t-10"><img onerror='imgError(this);' src="<?=Assets?>images/icons2.jpg" alt="" width="423" height="84" class="img-responsive"></p>
                     </div>
                     ...
                     <div class="col-sm-6 m-t-20">
                                ...
                                <div class="col-sm-12 " >
                                    ...
                                    <a href="#" data-target=".delivery_info" data-toggle="modal" class="textOrange">Term and Conditions</a> of sale. 
                                </div>
                ...
                <div class="col-sm-12 m-b-10 m-t-20" >
                         ...
                         <div class="col-xs-6  col-sm-6 col-md-6">
                                <div class="col-xs-6  col-sm-6 col-md-6  ">
                                  <div class="pull-left ">
                                     <button type="button" id="previous_3"  class="btn blue2 pull-left"><i class="fa fa-arrow-circle-left"></i> Shipping  </button>
                                  </div>
                                </div>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 ">
                            <div class="pull-right "> 
                              <button type="submit"  id="confirmbtn" class="btn orange pull-right">
