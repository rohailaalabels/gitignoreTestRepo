<?    
	...
	foreach($materials as $rec){
		...
		$materialinfo = $this->db->query("Select tooltip_info,short_name,group_name 
                  ...
                  <div class="dm-box">
                    <div class="btn-group btn-block dm-selector"> <a class="btn btn-default btn-block dropdown-toggle orientationselector"  data-toggle="dropdown" data-value="">Orientation 01<i class="fa fa-unsorted"></i></a>
                      <ul class="dropdown-menu btn-block">
                        ...
                        <li class="outsideorientation"><a data-toggle="tooltip-orintation" data-trigger="hover" data-placement="right" title="Labels on the outside of the roll. Text and image printed around the roll. Left-hand edge of the label of first." data-id="orientation4" data-value="4"> Orientation 04 <img src="<?=Assets?>images/loader.gif"></a></li>
                    ...
                    <select name="finish" class="labelfinish">
                     <option selected="selected" value="">Select Label Finish</option>
                      ...
                      <option value="Gloss Varnish">Gloss Varnish</option>
                   	  <option value="High Gloss Varnish">High Gloss Varnish (Not Over-Printable)</option>
