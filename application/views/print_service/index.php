...
<div id="aa_loader" class="white-screen" style=" display:none;">
    <div class="loading-gif text-center" style="top:135%; z-index:150;"><img onerror='imgError(this);'
...
<div class="printedBg">
    <div class="container">
        <div id="bg-index">
            ...
            <!-- AA33 STARTS -->
                <div class="col-sm-7 m-t-20 image_section_top"><img onerror='imgError(this);' class="img-responsive" src="<?= Assets ?>images/epson-print-22.png" alt="Epson Printer"/></div>
            <!-- AA33 ENDS -->
                ...
                <div class="col-sm-12 labels-form">
                    ...
                    <fieldset>
                        <div class="m-b-10 m-t-10">
                            ...
                            <!--<label class="select">
                <select id="category" name="category" autocomplete="off" class="disabled" >
                  <option selected="selected" value="Printed">Printed Labels on Rolls & Sheets</option>
                </select>
                <i></i> </label>-->
                        </div>
                        <div class="m-b-10 m-t-10">
        ...
        <div class="row" id="bg-step-1" style="display:none;">
            ...
            <div class="col-sm-7 m-t-10">
                <!-- AA48 STARTS -->
                    <div class="prBdec m-t-20" style="    margin-bottom: 20px;">    
                        <style>
                        ...
                        <?php
                        if( $this->uri->segment(1) == "printed-labels" && $this->uri->segment(2) == "circular" ) {?>
                            <h1 style="font-size: 17px; font-weight: bold;">Order Round Printed Labels Online</h1>
                            <div style="height: 116px; overflow: hidden;" id="actionContainer">
                                <p>Round printed labels are a best seller at AA Labels. As a specialist manufacturer, all of our custom labels benefit from high definition printing, ensuring a high quality standard, whatever the size of label. Their resilience and versatility makes these labels incredibly popular with our customers, as they can be used for many applications and the round edge drastically reduces any accident peeling.</p>

                                <p>We believe in providing our customers with the widest possible choice and offer our round printed labels in a range of sizes and colours, which can be supplied in roll or A4 sheet format.</p>

                                <p>We can professionally print your labels on a variety of materials depending on your need and label application, offering varying levels of adhesive for different storage conditions and uses.</p>

                                <p>Your product labels are a large part of your brand image. The quality of material, design, image, layout and finish are all critical factors in creating high quality labels that work for your business and actively promote your products. With our matt and gloss finishes, we’ll produce labels that truly reflect your company and its products.</p>

                                <p>Our paper and polyester labels are popular with retailers who choose our affordable circular labels for products and packaging, and use our easy peel adhesive labels as eye-catching sales labels.</p>

                                <p>With waterproof, heat resistant and cold resistant materials, our labels are popular with food manufacturers, artisan producers and research departments.</p>

                                <p>As well as making it easy for you to find the right printed circle labels for your next project, we can provide an instant quote to help you stay on budget.</p>

                                <p>Start your search for round printed labels today.</p>
                            </div>
                            <p class="read_more_less_style read_more_less" style="font-size: 13px;">Read More <i class="fa fa-angle-down"></i></p>
...
<div class="ourTeam" id="index_printing">
    <div class="container">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8">
                        <div class="col-md-12 ">
                                ...
                                <!-- AA48 STARTS -->
                                    <?php
                                    if( $this->uri->segment(1) == "printed-labels" && $this->uri->segment(2) != "circular" ) {?>
                                    <h1 style="font-size:22px; font-weight:bold;">Order Online for Digitally Printed Custom Labels</h1>
                                    <?php
                                    }
                                    else
                                    {?>
                                        <h2 style="font-size:16px; font-weight:bold;">Order Online for Digitally Printed Custom Labels</h2>
                                    <?php
                                    }
                                    ?>
                                    <p class="no-margin text-justify">
                                        Your printed labels are as important as your brand, product or organisational image in communicating your chosen values. The quality and design of a label says a lot about you and your brand, but a poor-quality label can say even more. At AA Labels, our custom printed labels are created to meet the high standards of our customers and their wide-ranging needs.<br> <br>
                                        We understand that the combination of label material, adhesive, design, print and finish are all critical elements in a label’s appearance and performance. We can also print your labels in a variety of shapes and sizes, in roll or sheet format. We’ll advise you on the most suitable options for the look you want to achieve, while also considering the practical needs of your label.<br> <br>
                    ...
                    <div class="hidden-xs col-md-4 col-sm-6 slidecarousel_height">
                        <div id="quote-carousel" data-ride="carousel" class="slide carousel">
                            <div class="carousel-inner" style="margin-top:10px;">
                                ...
                                <!-- AA33 STARTS -->
                                    <div class="item active"><img onerror='imgError(this);' class="" src="<?= Assets ?>images/categoryimages/labelShapes/slide011.png" alt="Epson Printer"></div>
                                <!-- AA33 ENDS -->
            ...
            <div class="row">
              ...
              <div class="hidden-xs col-sm-1"><img onerror='imgError(this);' class="nxt-img" src="<?= Assets ?>images/voucher-btn-con.png"></div>
                    ...
                    <div class="col-md-12 text-justify ">
                        <div class="col-md-12 ">
                             <!-- AA48 STARTS -->
                                <h2 style="font-size: 23px;">Custom Printed Labels of the Highest Quality</h2>
                                <p>From printed labels for bottles, to beauty products or craft beers, we support a variety of manufacturers with developing bespoke labels that reflect their products. In addition to regular, repeat custom printed label orders from large customer organisations, we also have many SME customers, with a number of first-time orders being placed daily.</p>
                                <p>Our customer care team are experienced and skilled in assisting start-up businesses with producing the custom printed labels they require and are happy to provide advice on everything to do with labelling. So, if you are looking for a labelling specialist that values short-run label business, then you have come to the right place.</p>
                                <p>Additional information about our custom printed label service is available in the tabs below.</p>
                            <!-- AA48 ENDS -->
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="tab_artwork">
                                ...
                                <div class="col-md-12 text-justify">
                                    ...
                                    <!-- AA33 STARTS -->
                                        <h2 style="color:#17b1e3;margin:0 0 1px;font-size:13px;padding-left:7px;font-weight:bold;">Artwork</h2>
                                    <!-- AA33 ENDS -->

                                    <div class="col-sm-12">
                                        
                                        <!-- AA33 STARTS -->
                                            <p>If you already have artwork prepared in a file saved format, then this can be uploaded with your order. Remember that all artwork amendments are likely to be chargeable by your graphic designer, so it’s best practice to only commission professional design services once all the elements of your design are finalised. If you do not have final artwork prepared for printing then we can help with this as well. Send your logo files (ideally in an EPS or PDF format), any images of your existing packaging, as well as any brand aspirations, or design ideas and for a small charge our studio team will be happy to design your printed labels for you.</p>
                                        <!-- AA33 ENDS -->
...
<div class="ourTeam" id="start_with_printing" style="display:none;">
    <div class="container">
        <div class="clear30"></div>
        <nav class="prLbSteps-nav">
            <ul>
                <li class="col-lg-2 col-md-3 col-sm-3 col-xs-12 no-padding step-1 prLbSteps-step-active prLbSteps-step-selected">
                ...
                <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12 step-2 no-padding "><a class="col-xs-12 no-padding"
        ...
        <div id="Printing_Step_1" class="StepContent">
            <? include('Step1.php') ?>
        </div>
        <div id="Printing_Step_2" class="StepContent" style="display:none;">
            <? include('Step2.php') ?>
        </div>
    ...
    <div class="printed-lba-call">
      <div class="container" >
        <div class="col-md-8 col-lg-9 col-sm-8 col-xs-12">
            ...
            <h3 class="m-b-100">CUSTOMER CARE We take pride in our service standards</h3><br />
            
            <p class="text-justify">
                We take pride in our service standards for online printed labels orders. Our reputation for service is built on our print quality, comprehensive product range and fast order fulfilment, along with the combined experience and knowledge of our customer care, studio and production teams. If you need assistance or help regarding the most suitable choice of printed label and finish for your label application, please contact our customer care team, via the live-chat facility on the page, our website contact form, telephone, or email and they will be happy to discuss your requirements.
            </p>

        </div>
        <div class="col-md-4 col-lg-3 col-sm-4 hidden-xs">
          <? if($is_mobile){?>
          <img alt="Customer Support" class="img-responsive" src="" data-normal="<?=Assets?>images/header/call_opr_1.png">
          <? }else{ ?>
          <img alt="Customer Support" class="img-responsive" src="<?=Assets?>images/header/call_opr_1.png">
          <? }?>
        </div>
      </div>
    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('[data-val="<?=ucfirst($shape)?>"]').addClass('active');
        $('#shape').val('<?=$shape?>');
        filter_size_data('shape');
        <? }else{ ?>
    ...
    $(document).on("click", ".matselector .dm-selector li a", function (e) {
        ...
        if (id == 'roll_material_selection') {
            $("#roll_material_selection .nlabelfilter").each(function (index){
                if ($(this).val().length == 0) { allchecked = false; return; }
            });
        } else {
...
*/
    ...
    function verify_labels_or_rolls_qty(id) {
        ...
        console.log('id:'+id);
        console.log('dieacross:'+dieacross);
        console.log('total_labels:'+total_labels);
        console.log('rolls:'+rolls);
        console.log('perroll:'+perroll);
        console.log('minlabels:'+minlabels);
        //return false;
    ...
    $(document).ready(function (e) {
        ...
        $("#email").focusout(function () {
            if (testEmail.test($("#email").val())) {
                ...
                $.post(base + 'ajax/add_email_to_session', {email: $("#email").val()});
    ...
    $(document).on("click", ".confirm_pref", function (e) {
        $("#ab_loader").show();
