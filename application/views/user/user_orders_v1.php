			 ...
			 ?>
                <div class="" >
                  <div class="col-md-12 bg-info p-t-b-12">
                    <div class="col-sm-8"> <strong>Order #</strong>
                      <?=$rec->OrderNumber?>
                    </div>
                    <div class="col-md-4">
                  ...
                  <div class="table-responsive col-md-12 p0 border0">
                    <table class="table table-bordered table-hover ">
                      <thead class="">
                        <tr>
                          ...
                          <th style="width:25%;">Buy More Get More ...</th>
                        </tr>
                      </thead>
                      <tbody>
                        <? 
                   ...
                   <tr>
                     ...
                     <td id="prd_name<?=$product->SerialNumber?>"><?=$product->ProductName;?></td>
                     ...
                     <td style="text-align:center;"><p id="price_<?=$product->SerialNumber?>"><strong>
                          <?  //new code
							...
							?>
                             ...
                             <? if($product->Printing=='Y' && $product->source=='flash'){?>
                              <div>
                             <a  <? if($priceFrom){?> data-toggle="tooltip" data-placement="left" title="<?=$priceFrom?>" <? }?>
                                     href="javascript:void(0);" onclick="add_integrated_line('<?=$product->SerialNumber?>','<?=$details['ManufactureID']?>');" > <i class="fa fa-shopping-cart"></i> Add to Cart </a>
                         </div>
                        ...
                        <td><div id="save_text<?=$product->SerialNumber?>">
                            <?=$product->Quantity?>
                            <?=$product_type?> / <?=$total_labels?>
                            Labels <?=$symbol.$product->Price;?>
                            (cost per label <?=$symbol.$cost_per?> ) </div></td>
                      </tr>
                      <? } ?>
                        </tbody>
				...
				<div class="col-md-12 bg-info p-t-b-12"><h4 style="text-align:center;">No order found in your account</h4></div>
