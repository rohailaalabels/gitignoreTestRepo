...
?>
        ...
        <input type="hidden" value="<?=$ProductID?>" id="cartproductid"  />
         ...
         <table class="table table-striped">
					...
					$total_sheets = 0;
                     ...
                     <tr class="upload_row">
                      <td class="text-center">
                        	  		 <img onerror='imgError(this);' class="img-circle" src="<?=$artworkpath?>" width="20" height="">
                      </td>
					 ...
					 <input type="text" data-placement="top" data-toggle="popover" data-content="" value="<?=($unitqty=='Labels')?$row->labels:$row->qty?>" 
                            class="form-control labels_input allownumeric artWork_No_Of_Sheets"  />
                            
					  </td>
                      <td width="16%"  align="center" style="vertical-align:middle;" class="text-center displaysheets">
					  	<?=($unitqty=='Sheets' || $unitqty=='sheets')?$row->labels:$row->qty?>
                      </td>
			...
			$expected_labels = $remaingsheets*$LabelsPerSheet;
                   ...
                   <tr class="upload_row uploadsavesection" style=" <?=(count($files)>0)?'display:none':''?>">
                     ...
                     <button class=" btn btn-primary browse_btn" > <i class="fa fa-cloud-upload"></i> Browse File</button>
                      ...
                      <td width="40%">
                            ...
                            placeholder="Enter <?=$sheets_text?>" value=""  type="text">
                      </td>
        ...
        <input type="hidden" id="upload_remaining_labels" value="<?=($remaingsheets*$LabelsPerSheet)?>"  />
