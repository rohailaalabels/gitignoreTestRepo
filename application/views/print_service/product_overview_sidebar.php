...
<div class="title text-center <?= (isset($sidebar_class) and $sidebar_class != '') ? $sidebar_class : 'orange' ?>"><b
        ...
        <div class="sfr">
            ...
            <? if ($details['labelCategory'] == 'Roll Labels') { ?>
                <div class="col-md-7 col-xs-12">
                    <div>
                        <button type="button" class="btn-block btn blueBg  f-14" data-toggle="modal"
                                data-target=".bs-example-modal-sm">Edit Label Orientation
                        </button>
                    </div>
                </div>
            <? } ?>
            ...
            <div class="col-md-12 clear">
                <div class="priceB row" style="clear:both;">
                    <div class="col-md-8 m-t-5 col-sm-8 col-xs-8">
                        <p>Line Total (
                            <?= vatoption ?>
                            VAT)</p>
                    </div>
