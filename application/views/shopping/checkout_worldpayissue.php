...
<div class="bgGray">
                                        ...
                                        <div class="p-l-r-10">
                                            ...
                                            <div class=" ">
                                                <label class="pull-right">
                                                    <a class="TextGray" href="<?= SAURL ?>users/forgotpassword">Forgot
                                ...
                                <div class="m-t-15">
                                    <div class="p-l-r-10">
                                        ...
                                        <div class="">
                                            ...
                                            <a href="<?= SAURL ?>transactionregistration.php?checkout=guest"
                        ...
                        <div class="col-sm-12 ">
                            <label class="input">
                                ...
                                <b class="tooltip tooltip-bottom-right">Enter your postcode and select your address from
                                    the locations found, using the drop-down menu.</b>
                        ...
                        <div class="col-sm-12 ">
                            <label class="input">
                                ...
                                <input type="text" placeholder="Address 1" value="<?= $billing_add1 ?>" name="b_add1"
                                       id="b_add1" class="required is_country_sel">
                        ...
                        <div class="col-sm-12 ">
                            <label class="input">
                                ...
                                <input type="text" placeholder="City/Town" value="<?= $billing_city ?>" name="b_city"
                                       id="b_city" class="required is_country_sel"> <b
                                        class="tooltip tooltip-bottom-right">Please Enter City or Town</b>
        ...
        <div class="setup-content" id="step-2">
                ...
                <div class="col-md-8 ">
                    ...
                    <label class="input">
                        ...
                        <input type="text" placeholder="First Name" id="d_first_name" name="d_first_name"
                               value="<?= $delivery_fname ?>" class="required"><b class="tooltip tooltip-bottom-right">Please
                            Enter First Name</b></label>
            ...
            <div class="col-sm-6">
                            ...
                            <optgroup label="EUROPE">
                                ...
                                foreach ($europe_list as $row) {
                                    ...
                                    <option <?= ($dcountry == $row->name) ? 'selected="selected"' : '' ?>
                                            data-vat="EUROPE" value="<?= $row->name ?>"><?= $row->name ?></option>
                                <? } ?>
                            </optgroup>
                ...
                <div class="col-sm-12 ">
                    <label class="input">
                        ...
                        <b class="tooltip tooltip-bottom-right">Enter your postcode and select your address from the
                            locations found, using the drop-down menu.</b>
                ...
                <div class="col-sm-12 ">
                    <label class="input">
                        ...
                        <input type="text" placeholder="Address 1" name="d_add1" value="<?= $delivery_add1 ?>"
                               id="d_add1"
                               class="required is_dcountry_sel"><b class="tooltip tooltip-bottom-right">Please Enter
                            Address Line</b>
                ...
                <div class="col-sm-12 ">
                    <label class="input">
                        <i class="icon-append fa fa-envelope-o"></i>
                        <input type="text" placeholder="Address 2" value="<?= $delivery_add2 ?>" class="is_dcountry_sel"
                ...
                <div class="col-sm-12 ">
                    <label class="input">
                        <i class="icon-append fa fa-map-marker"></i>
                        <input type="text" placeholder="County" class="is_dcountry_sel" value="<?= $delivery_county ?>"
    ...
    <div class="setup-content" id="step-3">
        ...
        <div class="">
            ...
            <div style="display:none;" class="col-sm-12 ukvatbox">
                <div class="col-md-8">
                    <label class="checkbox"><input type="checkbox" id="unreg_vat" name="unreg_vat" value="yes"
                                                   class="textOrange">
        ...
        <div id="delivertimeynote" class="col-sm-12 m-t-10">
            <div><p><small> <strong>Please note:</strong>
                        Orders placed before 16:00 qualify for next day delivery, providing this is not a weekend or UK
                        public holiday. Orders received after 16:00 will be treated as having been received the next
                        working day after placement, in production planning terms and the next working day for delivery
                        will be calculated accordingly. For a Saturday delivery the order must also be placed before
                        16:00 on the Friday before. </small></p></div>
            <hr>
        </div>
    ...
    <div class="setup-content" id="step-4">
        ...
        <div class="col-sm-12 col-xs-12 col-md-6 m-t-20 paymentdiv"
            ...
            <div class="paymentInputs11">
                ...
                <div class="m-t-10">
                                ...
                                <label class="cardsonfile select m-t-10" style="display:none; margin-bottom:0px;">
                                    <select name="creditcard" id="creditcard" class="required">
                                        ...
                                        <? foreach ($cards as $row) {
                                            ...
                                            ?>
                                            <option <?= ($row->is_default == 1) ? 'selected' : '' ?>
                                                    value="<?= $row->token ?>"><?= $cardname ?></option>
                                        <? } ?>
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="ps_container">
                            <style>.mobileBody #_el_input_nameoncard input {
                                    width: 50% !important;
                                }</style>
                            <script>
                    ...
                    <div class="col-md-7 m-t-10 paywithexistingcards" style="display:none;">
                        <a href="javascript:void(0);" class="textBlue paywithexistingcardsbtn">Pay using saved credit
                            cards</a>
                    </div>
                    <div class="clear"></div>
                ...
                <p class="m-t-10"><label class="radio borderRadius ">
                        ...
                        <i class="rounded-x m-l-10"></i>&nbsp; <strong>
                            Pay by PayPal
                            <!--<small>&nbsp;&nbsp; Please Note <img onerror='imgError(this);' src="<?= Assets ?>images/GBP.jpg"> GBP (&pound;) only.</small>-->
                        </strong>
                        <img onerror='imgError(this);' style="float:right;margin-top: -7px;"
                             src="<?= Assets ?>images/paypal.png" class="img-responsive hidden-xs hidden-sm">
                    </label>
                </p>
                ...
                <p class="m-t-10">
                    <label class="radio borderRadius ">
                        ...
                        <small> *(Government Departments, Ministries & Offices only e.g. Education, Emergency Services,
                            Local Authorities, NHS etc.)</small>
                    </label>
                </p>

                <div id="uploader_po" style="display:none;">
                    <div class="col-xs-8 col-sm-4"><input class="m-t-15" type="file" style="display:none;"
                                                          name="file_up" id="file_up"></div>
                    <div class="clear10"></div>
                    ...
                    <div class="col-xs-4 col-sm-4  ">
                        <img onerror='imgError(this);' width="60" height="" style="display:none;" id="preview_po_img"
                             src="#" alt="Preview Purchase Order"/>
                    </div>
                    <div class="clear10"></div>
                </div>
                ...
                <p style="display:none;" class="m-t-10 purchaseordertxt">
                    <small>* Please note: Your order will not be processed until we receive a signed copy of the
                        official Purchase Order via email at <a href="mailto:customercare@aalabels.com">customercare@aalabels.com</a>
                        or post to: AA Labels, 23 Wainman Road, Peterborough PE2 7BU</small>
                </p>
            </div>
            ...
            <div class="col-sm-12 secure-ssl-seal text-center m-t-20">
                <img onerror='imgError(this);' class="img-responsive"
                     src="<?= Assets ?>images/godaddy-secure-ssl-seal.png" alt="">
            </div>
        ...
        <div class="col-sm-12 col-xs-12 col-md-6 m-t-30">
            ...
            <div class="col-sm-12 paymentInputs11 normal_checkout m-t-30">
                <div class="col-sm-12 ">
                    ...
                    <a href="#" data-target=".delivery_info" data-toggle="modal" class="textOrange">Terms &amp;
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 no-padding ">
                    <div class="col-xs-12 pull-left no-padding ">
                        <button type="button" id="previous_3" class="btn blue2 pull-left btn-block">
                            <i class="fa fa-arrow-circle-left"></i> Shipping
                        </button>

                        <button type="button" id="back_to_payment" style="display:none;"
                                class="btn blue2 pull-left btn-block">
                            <i class="fa fa-arrow-circle-left"></i> Back to Payment Method
                        </button>
