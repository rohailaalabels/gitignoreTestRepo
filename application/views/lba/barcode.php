...
.barcodebg {
	background-image: url(https://www.aalabels.com/theme/site/images/header/bar-code-bg.jpg);
...
<div class="" style="background: white; padding: 0px;">
  <div class="">
    <nav class="prLbSteps-nav">
      <ul>
        <li class="col-sm-6 col-xs-12 no-padding prLbSteps-step-active prLbSteps-step-selected"> <a class="col-xs-12 no-padding show_barcode" tabindex="-1">
          <div class="col-xs-2 no-padding-left"><span class="cnt">1</span></div>
          <div class="col-xs-9 no-padding stepText"> Barcode Generator</div>
          </a></li>
        <li class="col-sm-6 col-xs-12 no-padding prLbSteps-step-active"><a
                    class="col-xs-12 no-padding show_qr" tabindex="-1">
              ...
              <div class="m-t-15">
                <div class="p-l-r-10">
                  <div class="barcode_sec select_type">
                    ...
                    <p>Please note: These are free generic and not unique barcodes. If you need a unique code this will need to be purchased from a supplier and uploaded into your artwork file.
</p>
                  ...
                  <div class="col-md-12 col-xs-12 barcode_sec">
                    <div class="row">
                      <div class="col-sm-6 border-right-dashed"> <strong>Barcode Data:</strong>
                        <input type="t  ext" class="form-control"
                                   id="barcode_data" maxlength="30">
                        <strong>Example: <span class="example-format">0123456789</span></strong>
                        <p class="error_data_qr text-danger"></p>
                        <div id="error_message"
                                 class="alert-danger m-t-10 p-l-r-15"
                                 style="display:none;"><i
                                    class="fa fa-times"></i> <span></span></div>
                      </div>
                      <div class="col-sm-6"> <strong>Barcode
                        Size: </strong>
                        <select class="form-control" name="barcode_size"
                                    id="barcode_size">
                  ...
                  <div>
                    <div class="padding-dashed-adjustment">
                      <div class="row">
                        <div class="col-md-6 text-center border-right-dashed m-t-30">
                          <button style="margin:13px 0;" type="button"
                                    class="btn  orange text-uppercase generate_barcode"> Generate Barcode &nbsp; <i
                                    class="fa fa-arrow-circle-right"></i> </button>
                        </div>
                        <div class="col-md-6 text-center">
                          <div class="text-center barcode_result_div">
                            ...
                            <div id="barcode_result"> <img  class="center-block img-responsive" src="" alt="Barcode"/> <a href="" style="margin:13px 0;" type="submit" data-role="button" class="btn orange text-uppercase" download="barcode.png">Download Barcode &nbsp; <i class="fa fa-arrow-circle-down"></i> </a> </div>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <form class="labels-form form-horizontal" id="qr_form">
          <div class="col-sm-12 m-t-10">
            ...
            <div class="borderPanel">
              <div class="m-t-15">
                <div class="p-l-r-10">
                  <div class="qr_sec select_type_qr padding-adjutsment-checbox">
                    <div class="row">
                      <div class="col-md-6">
                        <label class="radio"
                           style="font-size:12px; text-align:justify !important;">
                          <input type="radio"
                               class="textOrange validate-required"
                               name="qrcode_type" id="qrcode_type"
                               value="contact_info">
                      ...
                      <div class="col-md-6">
                        <label class="radio"
                          ...
                          <input type="radio"
                               class="textOrange validate-required"
                               name="qrcode_type" id="qrcode_type"
                               value="email" data-title="Email"
                               data-example="myname@mydomain.com">
                      ...
                      <div class="col-md-6">
                        <label class="radio"
                          ...
                          <input type="radio"
                               ...
                               data-example="This is a demo text">
                      ...
                      <div class="col-md-6">
                        <label class="radio"
                          ...
                          <input type="radio"
                               class="textOrange validate-required"
                               name="qrcode_type" id="qrcode_type"
                               value="phone" data-title="Phone"
                               data-example="(000)-000-0000">
                      ...
                      <div class="col-md-6">
                        <label class="radio"
                          ...
                          <input type="radio"
                               class="textOrange validate-required"
                               name="qrcode_type" id="qrcode_type"
                               value="url" data-title="URL"
                               data-example="http://www.example.com">
                          <i></i> <span>URL</span> </label>
                      </div>
                    </div>
                    <p class="error_type_qr text-danger"></p>
                  </div>
                  <div class="col-md-12 col-xs-12 barcode_sec qr plain_text"
             style="">
                    <div class="row">
                      <div class="col-sm-6 border-right-dashed">
                        <label for="qr_data" class="control-label">Plain
                          Text: </label>
                        <input type="text"
                                             class="form-control"
                                             id="qr_data">
                        <strong>Example:</strong> <span
                        class="example-format">Ths is the demo text</span>
                        <p class="error_data_qr text-danger"></p>
                        <div class="error_message_qr alert-danger m-t-10 p-l-r-15"
                         style="display:none;"><i
                            class="fa fa-times"></i> <span></span></div>
                      </div>
                      <div class="col-sm-6">
                        <label for="qr_size" class="control-label">QR
                          Code Size: </label>
                        <select class="form-control" name="qrcode_size"
                            id="qrcode_size">
                          <option value="">Select Size</option>
                          <option value="small">Small</option>
                          <option value="medium">Medium</option>
                ...
                <div class="col-md-12 col-xs-12 barcode_sec qr contact_info"
         style="display:none;    padding-top: 18px !important;">
                  <div class="error_message_qr alert-danger p-l-r-15 m-b-30"
             style="display:none;"><i class="fa fa-times"></i> <span></span></div>
                  ...
                  <div class="form-group">
                   ...
                   class="col-sm-3 control-label">Phone
                      Number: </label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control"
                       id="contact_number">
                  ...
                  <div class="form-group">
                    <label for="contact_zip" class="col-sm-3 control-label">Zip
                      Code: </label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control"
                       id="contact_zip">
                ...
                <div class="col-md-12 col-xs-12 barcode_sec qr sms_qr"
         style="display:none;padding-top: 17px !important;">
                  <div class="form-group">
                ...
                <div class="text-center">
                  <button style="margin:13px 0;" type="button"
                class="btn  orange text-uppercase generate_qr"> Generate QR Code &nbsp; <i
                class="fa fa-arrow-circle-right"></i></button>
                </div>
                <div class="text-center barcode_result_div">
                  ...
                  <div id="qr_result"> <img class="center-block img-responsive" src="" alt="Download Barcode"/> <a href="" style="margin:13px 0;" type="submit" data-role="button" class="btn orange text-uppercase" download="barcode.png">Download QR Code &nbsp; <i class="fa fa-arrow-circle-down"></i> </a> </div>
                </div>
              </div>
            </div>
          </div>
...
$(document).on("click",".generate_qr",function(e){
	...
	if(size == "" && (type == 'email' || type == 'phone' || type == 'url' || type == 'plain_text'))
	{
