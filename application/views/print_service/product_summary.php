<div class="thumbnail">
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 UploadMainSelection">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12"><a href="javascript:void(0);" data-value="3"
                                                                class="btn-block btn blue2  step-back" role="button"> <i
                                    class="fa fa-arrow-circle-left"></i> Back to Shape &amp; Size </a></div>
        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 lSumR print_option_box" style="display:none;">
            <div class="design_services" style="display:none;">
                <?php include_once(APPPATH . '/views/print_service/upload/print_designs_service.php'); ?>
            </div>
            ...
            <div class="upload_artwork" style="display:none;">
                <?php include_once(APPPATH . '/views/print_service/upload/upload_artwork_files.php'); ?>
            </div>
            <div class="clear"></div>
            <div class="col-md-12">
                <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="lSum">
                <div id="product_summary_overview" class="col-xs-12">
                    <?php include_once(APPPATH . '/views/print_service/product_overview_sidebar.php'); ?>
                </div>
            </div>
        </div>
    </div>
