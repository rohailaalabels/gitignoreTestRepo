    ...
    <div class="container">
                                ...
                                <div class="borderPanel">
                                    <div class="m-t-15">
                                        <div class="p-l-r-10">
                                            ...
                                            <div class=" ">
                                                <label class="pull-right"> <a class="TextGray"
                                ...
                                <div class="m-t-15">
                                    <div class="p-l-r-10">
                                        ...
                                        <div class=""><a href="<?= SAURL ?>transactionregistration.php?checkout=guest"
                                                         class="btn orange text-uppercase m-t-30"> Checkout As Guest
                                                &nbsp; &nbsp; <i class="fa fa-arrow-circle-right"></i> </a>
                                            <label class="pull-right"> <i class="fa fa-5x fa-user-plus cBlue"></i>
                                            </label>
                                        </div>
                                    </div>
                                </div>
            ...
            <form method="post" id="checkout_form" class="labels-form " enctype="multipart/form-data" action="">
                ...
                <div class="setup-content" id="step-1">
                        ...
                        <div class="col-md-8 ">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input type="text" name="b_first_name" placeholder="First Name" id="b_first_name"
                                       value="<?= $billing_fname ?>" class="required unsavedata">
                        ...
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input type="text" placeholder="Last Name" name="b_last_name" id="b_last_name"
                                       value="<?= $billing_lname ?>" class="required unsavedata">
                        ...
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-phone"></i>
                                <input type="text" placeholder="Phone Number" name="b_phone_no"
                                       value="<?= $billing_pno ?>" id="b_phone_no" class="required unsavedata">
                                <b class="tooltip tooltip-bottom-right">Please Enter Phone Number</b> </label>
                        </div>
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-phone"></i>
                                <input type="text" placeholder="Mobile Number" class="unsavedata" name="b_mobile"
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-search"></i>
                                <input type="text" placeholder="Postcode" value="<?= $billing_pcode ?>" name="b_pcode"
                                       id="b_pcode" class="required is_country_sel unsavedata">
                        ...
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                <input type="text" placeholder="Company Name" class="is_country_sel unsavedata"
                        ...
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-envelope-o"></i>
                                <input type="text" placeholder="Address 1" value="<?= $billing_add1 ?>" name="b_add1"
                                       id="b_add1" class="required is_country_sel unsavedata">
                        ...
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-envelope-o"></i>
                                <input type="text" placeholder="Address 2" value="<?= $billing_add2 ?>"
                                       class="is_country_sel unsavedata" name="b_add2" id="b_add2">
                                <b class="tooltip tooltip-bottom-right">Please Enter Address Line</b> </label>
                        </div>
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-map-marker"></i>
                                <input type="text" placeholder="City/Town" value="<?= $billing_city ?>" name="b_city"
                                       id="b_city" class="required is_country_sel unsavedata">
                                <b class="tooltip tooltip-bottom-right">Please Enter City or Town</b> </label>
                        </div>
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-map-marker"></i>
                                <input type="text" placeholder="County " class="required is_country_sel unsavedata"
                    ...
                    <div class="col-sm-4">
                        ...
                        <? } else { ?>
                            <div class="col-sm-12 ">
                                <label class="input"> <i class="icon-append fa fa-envelope-o"></i>
                                    <input type="email" placeholder="Email" value="<?= $billing_email ?>"
                                           class="unsavedata" name="email" id="email">
                                </label>
                            </div>
                            <div class="col-sm-12 ">
                                <label class="input"> <i class="icon-append fa fa-lock"></i>
                        ...
                        <div class="col-sm-12 ">
                            <label class="input"> <i class="icon-append fa fa-envelope-o"></i>
                                <input type="email" placeholder="Secondary Email" class="unsavedata"
        ...
        <div class="setup-content" id="step-2">
                ...
                <div class="col-md-4 ">
                    <label class="select">
                        <select name="title_d" id="title_d" class="unsavedata">
                            ...
                            <option <?php if ($DeliveryTitle == 'Miss.') { ?> selected <?php } ?> value="Miss.">Miss.
                            </option>
                            <option <?php if ($DeliveryTitle == 'Dr.') { ?> selected <?php } ?> value="Dr.">Dr.</option>
                            <option <?php if ($DeliveryTitle == 'Prof.') { ?> selected <?php } ?> value="Prof.">Ms.
                            </option>
                ...
                <div class="col-md-8 ">
                    <label class="input"> <i class="icon-append fa fa-user"></i>
                        <input type="text" placeholder="First Name" id="d_first_name" name="d_first_name"
                               value="<?= $delivery_fname ?>" class="required unsavedata">
                        <b class="tooltip tooltip-bottom-right">Please Enter First Name</b></label>
                </div>
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-user"></i>
                        <input type="text" placeholder="Last Name" name="d_last_name" value="<?= $delivery_lname ?>"
                               id="d_last_name" class="required unsavedata">
                        <b class="tooltip tooltip-bottom-right">Please Enter Last Name</b> </label>
                </div>
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-phone"></i>
                        <input type="text" placeholder="Phone Number" name="d_phone_no" value="<?= $delivery_pno ?>"
                               id="d_phone_no" class="required unsavedata">
                        <b class="tooltip tooltip-bottom-right">Please Enter Phone Number</b> </label>
                </div>
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-phone"></i>
                        <input type="text" placeholder="Mobile Number" class="unsavedata" name="d_mobile_no"
                ...
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-envelope-o"></i>
                        <input type="email" placeholder="Email" value="<?= $delivery_email ?>" name="d_email"
                               id="d_email" class="required unsavedata">
                    </label>
                </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-search"></i>
                        <input type="text" placeholder="Postcode" name="d_pcode" value="<?= $delivery_pcode ?>"
                               id="d_pcode" class="required is_dcountry_sel unsavedata">
                ...
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-user"></i>
                        <input type="text" class="is_dcountry_sel unsavedata" placeholder="Company Name"
                               name="d_organization"
                ...
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-envelope-o"></i>
                        <input type="text" placeholder="Address 1" name="d_add1" value="<?= $delivery_add1 ?>"
                               id="d_add1"
                               class="required is_dcountry_sel unsavedata">
                        <b class="tooltip tooltip-bottom-right">Please Enter Address Line</b> </label>
                </div>
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-envelope-o"></i>
                        <input type="text" placeholder="Address 2" value="<?= $delivery_add2 ?>"
                               class="is_dcountry_sel unsavedata" name="d_add2" id="d_add2">
                        <b class="tooltip tooltip-bottom-right">Please Enter Address Line</b> </label>
                </div>
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-map-marker"></i>
                        <input type="text" placeholder="City/Town" value="<?= $delivery_city ?>" name="d_city"
                               id="d_city" class="required is_dcountry_sel unsavedata">
                        <b class="tooltip tooltip-bottom-right">Please Enter City or Town</b> </label>
                </div>
                <div class="col-sm-12 ">
                    <label class="input"> <i class="icon-append fa fa-map-marker"></i>
                        <input type="text" placeholder="County" class="required is_dcountry_sel unsavedata"
        ...
        <div class="col-sm-12 m-b-10 m-t-20">
            <div class="pull-left m-t-10 m-b-10 m-r-5"><small> <strong>SMS:</strong> If you would like to receive text
                    messages about your orders despatch progress and delivery options, while on route with the courier.
                    Then please do not forget to provide the mobile phone number, to be used.</small></div>
            <div class="col-xs-12  col-sm-6 col-md-6">
                <div class="col-xs-12  col-sm-6 col-md-6  ">
                    <div class="col-xs-12 pull-left no-padding">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 ">
                <div class="col-xs-12 col-sm-6 pull-right ">
                    <button type="button" id="activate-step-3" class="btn orange pull-right btn-block"> Shipping <i
        ...
        <div class="col-sm-12 col-xs-12 col-md-7 m-t-30">
            ...
            <div class="col-sm-12">
                <div class="col-sm-12 paymentInputs11 secure-ssl-seal1 text-center m-t-10 borderRadius"
                     style="display:none;"><img onerror='imgError(this);' class="img-responsive"
                ...
                <div class="m-t-10">
                    <label class="radio borderRadius ">
                        ...
                        <i class="rounded-x m-l-10"></i> <img onerror='imgError(this);' style="float:right;"
                                                              ...
                                                              alt="Worldpay Logo"> &nbsp;&nbsp;<strong
                                style="font-size:14px; color:#333; ">Pay by Credit / Debit Card </strong> </label>
                    <?
                    if (isset($userid) and $userid != '') {
