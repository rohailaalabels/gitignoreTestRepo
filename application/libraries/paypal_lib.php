...
class Paypal_Lib {
	...
	{	$ipn_log_file = '.ipn_results.log';
		...
		//$this->paypal_url = 'https://sandbox.paypal.com/cgi-bin/devscr';
	...
	function paypal_auto_form() 
	{
		...
		echo '<p align="center">Please wait, your order is being processed and you will be redirected to the paypal website.</p>' . "\n";
...
$ipn_log_file = 'logs/.ipn_results.log';
		// Write to log
