      ...
      <div class="tab-content">
        <div id="tab_plain<?=$rec->ProductID?>" class="tab-pane tabplain active" role="tabpanel">
          <div class="row p-t-10" style="margin-top:45px;">
              ...
              <div class="col-xs-4 main-box">
                <div class="row">
                  ...
                  <div class="col-xs-10  no-padding-right"> <b>Free Delivery on Orders over
                    ...
                    </b> <a style="font-size:8px;" target="_blank" href="<?=base_url()?>delivery/">Delivery & Shipping Options</a> </div>
                </div>
              </div>
              <div class="col-xs-4 main-box">
                <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 quotation">
        ...
        <div id="tab_printed<?=$rec->ProductID?>" class="tab-pane tabprinted" role="tabpanel">
          <div class="row" style="margin-top:70px">
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
              ...
              <div class="clear"></div>
              <div class="row">
                <div class="col-lg-8 col-md-10 col-sm-7 col-xs-9"> <a href="#" class="btn btn-primary art-btn btn-block artwork_uploader" 
                                     data-target=".artworkModal1" data-toggle="modal" data-original-title="Upload Your Artwrok"> <i class="fa fa-cloud-upload" aria-hidden="true"></i>&nbsp; Click here to Upload Your Artwrok</a> </div>
              </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 quotation">
