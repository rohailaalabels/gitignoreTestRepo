                        ...
                        <div class="browing_history_home" style="background:none !important;">
                            <div class="p-l-r-10 order_history_div">
                                <p class="browing_history_title_home">Purchase History <span><a
                                                href="<?= base_url(); ?>users/user_orders">View All</a></span></p>
                                <div class="">
							...
							*/
                                                ...
                                                $col_sm_class_img = "col-sm-4";
                                                $col_class_text = "col-md-8 col-sm-8";
							...
							else
							{
								...
								$line_typee = "plain";
                                                ...
                                                if (preg_match("/A3/i", $prod[0]['ProductBrand']) || preg_match("/SRA3/i", $prod[0]['ProductBrand'])) {
                                                    $col_class_img = "col-md-6";
                                                    $col_sm_class_img = "col-sm-6";
                                                    $col_class_text = "col-md-6";
                                                }
                                                ?>
                                                ...
                                                ?> col_line" <?= $data_merge ?>>
                                                    ...
                                                    <input type="hidden" id="ManufactureID"
                                                           value="<?= $line->ManufactureID ?>"/>
                                                    <input type="hidden" id="ProductID"
                                                           value="<?= $line->ProductID ?>"/>
                                                    <input type="hidden" id="prd_name<?= $line->SerialNumber ?>"
                                                           value="<?= $line->ProductName; ?>"/>
                                                    <input type="hidden" id="cart_id_<?= $line->SerialNumber ?>"
                                                           value=""/>
                                                    <input type="hidden" id="labels_p_sheet<?= $line->SerialNumber ?>"
                                                           value="<?= $details['LabelsPerSheet'] ?>"/>
                                                    <input type="hidden" id="Quantity_<?= $line->SerialNumber ?>"
                                                           value="<?= $line->Quantity ?>"/>
                                                    <input type="hidden" id="Quantity_new_<?= $line->SerialNumber ?>"
                                                           value="<?= $line->Quantity ?>"/>
                                                    <input type="hidden"
                                                           id="No_Labels_Original<?= $line->SerialNumber ?>"
                                                           value="<?= $no_of_labels_original ?>"/>
                                                    <input type="hidden" id="min_qty<?= $line->SerialNumber ?>"
                                                           value="<?= $min_qty ?>"/>
                                                    <input type="hidden" id="max_qty<?= $line->SerialNumber ?>"
                                                           value="<?= $max_qty ?>"/>
                                                    <input type="hidden" id="min_print_labels<?= $line->SerialNumber ?>"
                                                           value="<?= $min_labels_per_roll ?>"/>
                                                    <input type="hidden" id="max_print_labels<?= $line->SerialNumber ?>"
                                                           value="<?= $max_labels_per_roll ?>"/>
                                                    <input type="hidden" id="product_type<?= $line->SerialNumber ?>"
                                                           value="<?= $product_type ?>"/>
                                                    <input type="hidden" id="prd_id<?= $line->SerialNumber ?>"
                                                           value="<?= $line->ProductID ?>"/>
                                                    <input type="hidden" id="manufactureID<?= $line->SerialNumber ?>"
                                                           value="<?= $line->ManufactureID ?>"/>

                                                    <input type="hidden" id="materialCode<?= $line->SerialNumber ?>"
                                                           value="<?= $this->home_model->getmaterialcode($line->ManufactureID) ?>"/>

                                                    <input type="hidden" id="print_type<?= $line->SerialNumber ?>"
                                                           value="<?= $print_type ?>"/>
                                                    <input type="hidden" id="labeltype<?= $line->SerialNumber ?>"
                                                           value="<?= $plabeltype ?>"/>
                                                    <input type="hidden" id="finishtype<?= $line->SerialNumber ?>"
                                                           value="<?= $line->FinishType ?>"/>
                                                    <input type="hidden" id="printQty<?= $line->SerialNumber ?>"
                                                           value="<?= $line->Print_Qty ?>"/>
                                                    <input type="hidden" id="source<?= $line->SerialNumber ?>"
                                                           value="<?= $print_source ?>"/>
                                                    <input type="hidden" id="orderNum_<?= $line->SerialNumber ?>"
                                                           value="<?= $line->OrderNumber ?>"/>
                                                    <input type="hidden" id="cart_id_<?= $line->SerialNumber ?>"
                                                           value=""/>
                                                    <input type="hidden" id="gap_<?= $line->SerialNumber ?>"
                                                           value="<?= $die_details->LabelGapAcross ?>"/>
                                                    <input type="hidden" id="diesize_<?= $line->SerialNumber ?>"
                                                           value="<?= $die_details->Height ?>"/>
                                                    <input type="hidden" id="orientation<?= $line->SerialNumber ?>"
                                                           value="<?= $line->Orientation ?>"/>
                                                    <input type="hidden" id="wound<?= $line->SerialNumber ?>"
                                                           value="<?= $line->Wound ?>"/>
                                                    <input type="hidden" value="<?= count($artworks) ?>" data-qty="0"
                                                           id="uploadedartworks_<?= $line->SerialNumber ?>"
                                                           data-presproof="<?= $line->pressproof ?>">
                                                    <input type="hidden" id="printing<?= $line->SerialNumber ?>"
                                                           value="<?= $line->Printing ?>"/>
                                                    <input type="hidden" id="regmark<?= $line->SerialNumber ?>"
                                                           value="<?= $line->regmark ?>"/>
                                                    <input type="hidden" id="sheet_qty_<?= $line->SerialNumber ?>"
                                                           value="<?= $line->Quantity ?>"/>
                                                    <div class="image_thumbnail <?php echo $col_class_img;
                                                    echo ' ';
                                                    echo $col_sm_class_img; ?>"><img src="<?= $path ?>"
                                                                                     class="img-responsive hover_image_zoom"/>
                                                    </div>
                                                    <div class="order_line_description <?= $col_class_text ?>">
                                                        <div class="<?= $div_class ?>">
                                                            <div class="history_manufacture_top <?= $div_class1 ?>">
                                                                <strong>Order #:</strong>
                                                                <?= $line->OrderNumber ?>
                                                            </div>
                                                        ...
                                                        <hr/>
                                                        <div class="browsing_middle"> <span
                                                                    class="<?= $complete_name_div ?>">
                          <?php
                          $max_length = 93;
                          if (strlen($completeName) > $max_length) {
                              $offset = ($max_length - 3) - strlen($completeName);
                              $short_desc = substr($completeName, 0, strrpos($completeName, ' ', $offset)) . '...';
                              //$short_desc .= ' <a style="cursor:pointer;" data-toggle="tooltip" data-placement="top" data-original-title="'.$completeName.'"><i>Lire Plus</i></a>';
                          } else {
                          ...
                          <div class="row">
                            ...
                            <? 	}
							   ...
							   {
							?>
                            <div class="col-xs-3 col-sm-3 col-md-3 more_artworks_home"> <a href="javascript:void(0);" class="view_more_designs" data-productID="<?=$line->SerialNumber?>">Voir<span>
                              <?=count($artworks) - 3;?>
                              plus</span> dessins</a> </div>
                            <?
										}
									?>
                          </div>
                          ...
                          <strong>Service d'impression (Marque d'immatriculation noire au verso)</strong>
                          <? } ?>
                          <?php */
                                                            ?>
                                                            <p class="text-right price_txt clear <?= $classs ?>">
                                                                <strong>
                          ...
                          <? } ?>
                                                        ...
                                                        <div class="col-md-12 text-right">
                                                            ...
                                                            <? if ($line->Printing == 'Y' && $line->source != 'flash' && $line->regmark != "Y") { ?>
                                                                ...
                                                                <a class="artwork_uploader btn btn-xs btn-block orangeBg continue_place_order"
                                                                   href="javascript:void(0);"
                                                                   data-target=".artworkModal1" data-toggle="modal"
                                                                   data-productid="<?= $line->SerialNumber ?>"
                                                                   data-actual_productid="<?= $line->ProductID ?>"
                                                                   data-manufactureid="<?= $line->ManufactureID ?>"
                                                                   data-product_type="<?= strtolower($product_type) ?>"
                                                                   data-labelsacross="" data-labelsize="">Re-Order</a>
                                                            <? } else { ?>

                                                                <?php
                                                                if ($line->Print_Type == "Sample") {
                                                                    ?>
                                                                    <a href="javascript:void(0);"
                                                                       class="btn btn-xs btn-block newbutton orangeBg redorderBtn"
                                                                       onclick="sampleToCart('<?= $line->SerialNumber ?>');">Re-Order</a>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <a href="javascript:void(0);"
                                                                       class="btn btn-xs btn-block newbutton orangeBg redorderBtn"
                                                                       onclick="add_item('<?= $line->SerialNumber ?>','<?= $line->ManufactureID ?>');">Re-Order</a>
                                                                    <?php
                                                                }
                                                            } ?>
                                                        </div>
