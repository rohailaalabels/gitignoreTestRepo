        ...
        <div >
          ...
          <div class="col-md-9">
            <div id="specs_loader" class="white-screen hidden-xs" style="display:none;">
              <div class="loading-gif text-center" style="top:26%;left:29%;"> <img src="<?=Assets?>images/loader.gif" width="181" height="181" class="image" style="width:181px; height:181px; "> </div>
            </div>
		...
		if(menuid){
			$.ajax({
						...
						if(!data==''){	
								...
								data = $.parseJSON(data); 
								if(data.response=='yes'){
									var sample_txt = "Thank you for requesting a sample, an roll label of the material chosen will be sent via the post. \n\n Please note: The label size on the sample will not match the label/s on this page.";
