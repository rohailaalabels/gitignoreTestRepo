                        ...
                        foreach ($order_detail as $pro) {
                            ...
                            <tr>
                                <th <?= ($pro['Printing'] == 'Y') ? 'rowspan="2"' : '' ?> class="">
                                    ...
                                    <img onerror='imgError(this);' class="img-circle"
                                         src="<?= Assets ?>images/material_images/<?= $image ?>" alt="" width="46"
                                         height="46"></th>
                                <td><h4><?= $pro['ManufactureID'] ?></h4>
                                    <p><?= $pro['ProductName'] ?></p></td>
                                <td style="text-align:center;"><strong>£<?= $pro['Price'] ?></strong></td>
                                <td><strong>£<?= $pro['ProductTotal'] ?></strong></td>
                                <td><strong><?= $pro['Quantity'] ?></strong></td>
                            </tr>
            ...
            <form method="post" id="checkout_form" class="labels-form ">
                    ...
                    <div class="col-sm-12 m-t-30">
                        <div class="col-sm-6">
                            <div>
                                ...
                                <p id="billing_name_review"><?= $order['BillingTitle'] . " " . $order['BillingFirstName'] . " " . $order['BillingLastName'] ?></p>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div>
                                ...
                                <p id="billing_name_review"> <?= $order['DeliveryTitle'] . " " . $order['DeliveryFirstName'] . " " . $order['DeliveryLastName'] ?></p>
                                <span id="billing_address_review">
                ...
                <div class="col-sm-12 m-t-30">
                    <div class="col-sm-6">
                        ...
                        <div>
                            <strong class="textBlue">Payment</strong><br>
                            ...
                            <div class="">
                                ...
                                <div id="loader_div" align="center" class="white-screen" style=" display:block;">
                                    <img onerror='imgError(this);' src="<?= Assets ?>images/loader.gif" width="181"
                                         height="181" class="image" style="width:181px; height:181px; ">
                                </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="textBlue m-b-6">
                            <strong class="">Order Summary (<?= $order['OrderNumber'] ?>)</strong>
                        ...
                        <img onerror='imgError(this);' class="m-t-15 img-responsive"
                             src="<?= Assets ?>images/icons2.jpg" width="423" height="84">
