   ...
   <form id="artwork_approval" method="post">
    ...
    <div class="thumbnail prMatDC">
      ...
      <div class="col-md-12">
        ...
        <p id="decline-section" style="display:none">You have selected a previously declined version, please click proceed to continue.</p>
        <p id="qa-section-header"> Before approving this artwork for printing, it is important that you check the following: </p>
        <div class="table-responsive" id="qa-section">
         ...
         <? }else{ ?> <input name="feedback[q1]" class="textOrange approve ischeck hide" value="1"  type="radio" checked="checked"/> <? } ?>
          ...
          <? if($max['q2']==0){   $item++; ?>  
           ...
           <? }else{ ?> <input name="feedback[q2]" class="textOrange approve ischeck hide" value="1"  type="radio" checked="checked"/> <? } ?>
        ...
        <? }else{ ?> <input name="feedback[q3]" class="textOrange approve ischeck hide" value="1"  type="radio" checked="checked" /> <? } ?>
        ...
        <? }else{ ?> <input name="feedback[q4]" class="textOrange approve ischeck hide" value="1"  type="radio" checked="checked" /> <? } ?>
      ...
      <? }else{ ?> <input name="feedback[q5]" class="textOrange approve ischeck hide" value="1"  type="radio" checked="checked" /> <? } ?>
        ...
        <?  if(preg_match('/roll/is',$result['ProductName'])){ ?>
              ...
              <? }else{ ?> <input name="feedback[q6]" class="textOrange approve ischeck hide" value="1"  type="radio" checked="checked" /> <? } ?>
                ...
                <? }else{ ?> <input name="feedback[q7]" class="textOrange approve ischeck hide" value="1"  type="radio" checked="checked" /> <? } ?>
      ...
      <p class="text-justify" id="qa-section-footer">Once you have checked and approved your label design, please use the button below to repeat the process for other designs and to proceed with the production of your printed labels. If the design/s require amendment, use the commentary boxes on the right of the form, adjacent to the tick boxes, to enter details of your requirements and return to the customer care team for action using the button below.</p>
        ...
        <input type="hidden" name="feedback[version]"  id="artworkversion" value="<?=$result['version']?>"/>
        ...
        <div class="">
          <div class="row">
            ...
            <div class="col-md-4  col-sm-4 col-xs-12 text-center"> 
            	<strong class="cBlue artworkno" id="artworkno"> 1 </strong> of <strong class="cBlue"> <?=$total?>  </strong> 
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
            
             <button type="button"  id="pleasewaitbutton" class="btn btn-block orange" disabled style="display:none">
                 <img onerror='imgError(this);' id="world_loader_icon" src="<?=Assets?>images/ring.gif" alt="AA Labels Loader"/> Please Wait.... <i class="fa fa-arrow-circle-right"></i> 
             </button>
                              
              <button type="button" class=" btn btn-block orange pull-right formsubmit" name="feedback[type]" value="approve" id="approver"> 
              Proceed <strong class="artworkno" > 1 </strong> of <strong class=""> <?=$total?>  </strong>  </button>
              
              <button class="btn btn-block orange formsubmit" type="button" name="feedback[type]" value="amend" style="display:none" id="amender"> Proceed <strong class="artworkno" > 1 </strong> of <strong class=""> <?=$total?>  </strong> 
              </button>
            </div>
          </div>
        </div>
...
$(document).on("click", ".ReviseSoftproofsList", function(e) {
	var checkddecline = $(this).attr('data-loop');
	...
	if(checkddecline>1){ title = title+' - <b style="color:red">Declined</b>'; } 
