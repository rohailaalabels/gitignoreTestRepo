<style>
.floating_li { float:left; clear:left; border:1px solid black;}
</style>
<div class="">
  ...
  <div class="container">
    <div class="panel">
        ...
        <div class="col-sm-6 col-md-6 p-l-r-15 pull-right">
          <a role="button" class="btn orange pull-right" href="<?=base_url()?>"> <i class="fa fa-arrow-circle-left faa-horizontal animated"></i>&nbsp; Continue Shopping </a>
          ...
          <div class="setup-content" id="step-2">
            <div class="">
              ...
              <div class="col-md-12 p0"  style="list-style:none;" >
                  <?php $i=1; foreach($application_type as $option){?>
               
					
                    
                  <div class="col-md-3  m-l-20 m-b-10">
                    <label class="checkbox">
                      <input id="application_array" name="application_array[]" type="checkbox" class="textOrange app_checked" value="<?=$option->ID?>">
                      <i></i> <?=$option->Type?></label>
                  </div>
          ...
          <div class="setup-content" id="step-3">
            <div class="">
              ...
              <div class="col-sm-12 p0">
                ...
                <p class="m-t-b-8 m-l-20">Please tell us about the three most important aspects of our products and service for you, by ticking three of the headings on this page.
</p>
              </div>
              <div class="col-sm-12">
                <? 
                ...
                <div class="col-md-4 m-b-10">
                  <div>
                    ...
                    <div class="col-md-4">
                    <label class="checkbox">
                      <input id="rating_val" name="rating_val[]" type="checkbox" class="textOrange app_checked" value="<?=$chosing->ID?>">
                        <i></i> </label>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-12">
                <div class="col-md-12">
                  <label class="input">
                    <textarea name="reason_other" id="reason_other" placeholder="Any other comments:" rows="6" class="form-control"></textarea>
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="setup-content" id="step-4">
            <div class="cfq">
              <div class="col-lg-6 col-md-6 col-sm-12 detail-text">
                <p>We thank you for taking the time to complete this brief questionnaire and your answers will help us to understand how we might improve still further the products and service available for customers.</p>
              </div>
              
              <div class="col-lg-6 col-md-6 col-sm-12 pp-link">
                
               <a href="#" data-target=".delivery_info" data-toggle="modal" class="pull-right">aaLabels Privacy Policy <i aria-hidden="true" class="fa fa-arrow-circle-right"></i></a>
              </div>
            ...
            <div class="col-sm-12 m-b-10" >
              ...
              <div class="col-xs-6 col-sm-6 col-md-6 ">
                <div class="pull-right ">
                  <button type="submit" id="activate-step-5" class="btn orange m-t-15 pull-right">Submit Now <i class="fa fa-arrow-circle-right"></i> </button>
                </div>
              </div>
            </div>
          </div>
