...
<section data-mat-filters="<?=$rec->ColourMaterial?>" data-reset="reset" >
  <div class="row productdetails <?=($type=='Rolls')?'roll-products':''?>" data-value="<?=$rec->ProductID?>" 
    ...
    <article class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mat-detail mat-tabs">
      ...
      <div class="clear"></div>
      <div class="row specs">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"> <img onerror='imgError(this);' class="img-responsive product_material_image" src="<?=$mat_image?>" alt="Free Samples"> </div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 m-t-10">
			  ...
			  if(count($adhesive) == 1):?>
                ...
                <label class="select">
                  ...
                  <i></i> </label>
                <?php endif;?>
                <button class="btn orangeBg btn-block rsample" type="button">Add Free Sample to Cart <i class="fa fa-calculator"></i> </button>
                </div>
            </div>
          </div>
        </div>
          ...
          <table class="table printer" border="0" style="border:none;">
            <tbody>
              <tr>
                ...
                <td  align="left" style="font-size:9px; border:none; width:25%;<?=$laser_div?>"> Laser <a data-toggle="tooltip-product" data-placement="top" class="laser_printer_div" title="" data-original-title="<?=$comp['laser_text']?>" href="javascript:void(0);"><i class="fa fa-info-circle"></i></a><br /><br />
                  <img onerror='imgError(this);' class="laser_printer_img" width="50" src="<?=Assets?>images/<?=$comp['laser_img']?>"  /></td>
                <td  align="left" style=" font-size:9px;border:none;width:25%;<?=$inkjet_div?>"> Inkjet <a data-toggle="tooltip-product" data-placement="top" title="" class="inkjet_printer_div" data-original-title="<?=$comp['inkjet_text']?>" href="javascript:void(0);"><i class="fa fa-info-circle"></i></a><br /><br />
