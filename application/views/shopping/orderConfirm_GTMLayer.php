                    ...
                    <form novalidate action="852" method="post" enctype="text/plain" id="8524" class="">
                        <div class="">
                            ...
                            <div class="col-sm-12">
                                ...
                                <p class="m-l-20">Thank you for your order and a Confirmation of Order email has been
                                    sent to the email address provided, as shown below. We will contact you again when
                                    your order is ready for despatch and provide a reference enabling you to track
                                    delivery. </p>
