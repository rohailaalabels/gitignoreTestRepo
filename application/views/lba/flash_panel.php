...
<div class="row">
 <div class="col-sm-12">
    ...
    <?php 
	   // $link_bind ='http://gtserver/newlabels/';
		$link_bind = AJAXURL;
        $temp_id    = $temp_id;  
        $is_admin = "false";
	 ...
	 ?>
		<!--<div align="center">-->
	<object type="application/x-shockwave-flash" style="padding-top:15px; padding-bottom:5px;" data="<?=$link_bind?>Labeler/Editor.swf?v=3.10" width="100%" height="726" id="Source" style="float: none; vertical-align:middle">
				<param name="movie" value="<?=$link_bind?>Labeler/Editor.swf?v=3.10" />
