            ...
            <div class="col-xs-12 col-sm-4 col-md-2">
                <? if ($curnt_chat['thumb'] != '') { ?>
                    <img onerror='imgError(this);'
                         src="<?= AJAXURL ?>/theme/site/printing/chat/thumb/<?= $curnt_chat['thumb'] ?>" width="150"
                         alt="AA Labels"/>
                <? } ?>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-2">
                ...
                <? if ($curnt_chat['pdf'] != '') { ?>
                    <a href="<?= AJAXURL ?>/theme/site/printing/chat/pdf/<?= $curnt_chat['pdf'] ?>" target="_blank">
                        <button class="btn btn-block orangeBg" type="button"><i class="fa fa-cloud-download"
                                                                                aria-hidden="true"
                                                                                style="font-weight:bold;"></i>&nbsp;Download
                        </button>
                    </a>
                <? } ?>
            </div>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 SoftProofM">
    <div class="thumbnail prMatDC col-lg-9 col-md-9 col-sm-12 col-xs-12 pull-left">
        ...
        <div class="scale-img"><img onerror='imgError(this);' class="img-responsive product_material_image"
                                    src="<?= $soft ?>" id="main_image_softproof" alt="AA Labels Softproof"></div>
    </div>
        ...
        <div id="ReviseHistoryMain">
            ...
            foreach ($history as $rowp) {
                ...
                <div class="RevisionHistory col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="ReviseSoftproofsList"><img onerror='imgError(this);'
                                                           class="img-responsive history_softproof "
                                                           src="<?= $revissoft . $rowp->softproof ?>"
                                                           title="<?= $result['name'] ?> (<?= $vtype ?>)"
                                                           alt="<?= $rowp->ref ?>">
                    ...
                    <? if ($custfeed['q2'] == 1) { ?>
                        <div class="ReviseSoftProofQA text-justify">
                            <h2>Q:Is the content information correct e.g. Asset codes, bar codes, contact details,
                                dates, ingredients, prices etc?</h2>
                            <p><span>A:</span>
                                <?= $q2 ?>
                            </p>
                        </div>
                    ...
                    <? if ($custfeed['q4'] == 1) { ?>
                        <div class="ReviseSoftProofQA text-justify">
                            <h2>Q:Is the alignment and ratio of the artwork correct e.g. As supplied and/or amended and
                                agreed?</h2>
                            <p><span>A:</span>
                                <?= $q4 ?>
                            </p>
