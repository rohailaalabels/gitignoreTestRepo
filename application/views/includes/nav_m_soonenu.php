  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="collapse navbar-collapse navbar-main-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="dropdown mega-dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" data-url="#">Labels on sheets &amp; Rolls</a>
          <div class="dropdown-menu mega-dropdown-menu">
            <ul class="col-sm-12 nav nav-tabs nav-justified" role="tablist">
              <li role="presentation" class="active"> <a href="#tc-2" aria-controls="tc-2" role="tab" data-toggle="tab">Labels by Shapes &amp; Size</a> </li>
              <li role="presentation" class=""><a href="#tc-1" aria-controls="tc-1" role="tab" data-toggle="tab">Labels by Material</a> </li>
            ...
            <div class="tab-content clearfix"> 
              ...
              <div role="tabpanel" class="tab-pane active" id="tc-2"> 
                ...
                <!-- Labels on A4 Sheet -->
                <div class="col-sm-6 col-md-3 col-xs-6" nav-item-pos="ni-1-2-2"> <img alt="Sheets" src="<?=Assets?>images/icon-sheet.png" class="img-responsive roll-icon-nav"/>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <ul class="nav">
                        ...
                        <li><a href="<?=base_url()?>a4-sheets/anti-tamper/">Tamper Evident Labels</a></li>
                ...
                <div class="col-sm-6 col-md-3 col-xs-6" nav-item-pos="ni-1-2-1"> <img alt="Rolls" src="<?=Assets?>images/icon-roll.png" class="img-responsive roll-icon-nav"/>
                ...
                <div class="col-sm-12 thin-pad hidden-xs text-center hide" style="margin-top:-10px;margin-bottom:20px;">
                	<a href="<?=base_url()?>special-offer-materials/" class="btn orangeBg">View Special Promotions <i class="fa fa-gift"></i></a>
                </div>
                <div class="col-sm-12 thin-pad hidden-xs">
                  ...
                  <div class="row">
                    <div class="col-sm-3"> <img src="<?=Assets?>images/menu-banner-1.jpg" class="img-responsive border0" alt="Dry Edge Labels"/> </div>
                    <div class="col-sm-3"> <a href="<?=base_url()?>sample-request/sheets/"> <img src="<?=Assets?>images/menu-banner-2.jpg" class="img-responsive border0" alt="Label Sample Request"/> </a> </div>
                    <div class="col-sm-3"> <a href="<?=base_url()?>customlabels.php/"> <img src="<?=Assets?>images/menu-banner-3.jpg" class="img-responsive border0" alt="Custom Labels Sizes"/> </a> </div>
                    <div class="col-sm-3"> <a href="<?=base_url()?>roll-labels/"> <img src="<?=Assets?>images/menu-banner-4.jpg" class="img-responsive border0" alt="Custom Labels Sizes"/> </a> </div>
                  </div>
                </div>
              </div>
              ...
              <div role="tabpanel" class="tab-pane" id="tc-1">
                <div class="plain_labels_section"> 
                  ...
                  <!-- Labels on Sheets -->
                  <div class="col-sm-6 col-md-6" nav-item-pos="ni-1-1-2"> <img alt="Sheets" src="<?=Assets?>images/icon-sheet.png" class="img-responsive roll-icon-nav"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 col-xs-6">
                        ...
                        <label><a href="<?=base_url()?>specialist-label-material/">Specialist Materials</small> </a></label>
                        <ul class="nav">
                          <li><a href="<?=base_url()?>material-on-sheets/matt-white-polyethylene?code=PETC">Cryogenic (-196°C)</a></li>
                          <li><a href="<?=base_url()?>material-on-sheets/matt-white-polyethylene?code=PETH">Heat Resistant (121°C) </a></li>
                          <li><a href="<?=base_url()?>material-on-sheets/matt-white-aluminium-back-coated-paper/">Aluminium Back Coated</a></li>
                          ...
                          <li><a href="<?=base_url()?>specialist-label-material/">View All</a></li>
                        </ul>
                        <label>Samples</label>
                        <ul class="nav">
                  ...
                  <div class="col-sm-6 col-md-6" nav-item-pos="ni-1-1-1"> <img alt="Rolls" src="<?=Assets?>images/icon-roll.png" class="img-responsive roll-icon-nav"/>
                    <h5>Labels on Rolls</h5>
                    <!-- Paper -->
                    <div class="row">
                      <div class="col-sm-6 col-xs-6">
                      ...
                      <div class="col-sm-6 col-xs-6">
                        ...
                        <ul class="nav">
                          ...
                          <li><a href="<?=base_url()?>material-on-rolls/matt-white-polyethylene?code=PEOP">Matt White – Block out/Cover-Up</a></li>
                        </ul>
                        ...
                        <ul class="nav">
                          ...
                          <li><a href="<?=base_url()?>material-on-rolls/matt-white-dissolving-paper/">Matt White Dissolving - Paper</a></li>
                          <li><a href="<?=base_url()?>specialist-label-material/">View All</a></li>
                        </ul>
                        <label>Samples</label>
                        <ul class="nav">
              ...
              <div role="tabpanel" class="tab-pane adhesive_tab" id="tc-3">
                <div class="col-sm-12" nav-item-pos="ni-1-3-1"> 
                  ...
                  <div class="row">
                    <div class="plain_labels_section">
                      <div class="col-md-6 col-sm-6 col-xs-12"> <img alt="Sheets" src="<?=Assets?>images/icon-sheet.png" class="img-responsive roll-icon-nav"/>
...
"></i></label>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12"> <img alt="Rolls" src="<?=Assets?>images/icon-roll.png" class="img-responsive roll-icon-nav"/>
                        <h5>Labels on Rolls</h5>
                        ...
                        <div class="col-sm-6 col-sm-6 col-xs-6">
                          ...
                          <label><a href="<?=base_url()?>labels-by-adhesive-rolls/freezer/">Freezer </a> <i class="fa fa-info-circle" data-toggle="tooltip" data-title="A general purpose acrylic based  pressure sensitive permanent adhesive. With a usage temperature of down to -40°C. The commercial uses for this type of label are for cold storage and frozen/chilled distribution. Also used in other temperature controlled environments and excellent for domestic use in home freezing."></i></label>
                          <ul class="nav">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane Direct_Thermal_Printers_Rolls" id="c">
                        <div class="row">
                          ...
                          <div class="col-md-7 col-xs-6 hidden-xs"> <img alt="Barcode Printer" src="<?=Assets?>images/header/barcode-printer.jpg" class="img-responsive"/> </div>
                        </div>
                      </div>
                      <div class="tab-pane Inkjet_Printers_Rolls" id="d">
                        <div class="row">
                          ...
                          <div class="col-md-6 col-xs-12">
                          	<a href="<?=base_url()?>roll-labels/"><img src="<?=Assets?>images/Menu-Big-Banner.jpg" style="float:right;" /></a>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="row">
                          <div class="col-md-6 col-xs-6">
                            <ul class="nav">
                              ...
                              <li><a href="<?=base_url()?>material-on-rolls/matt-white-polyethylene/?code=PEOP">Matt White - Polyethylene</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/economy-white-direct-thermal-paper/">Matt White - Direct Thermal Paper</a></li>
                          ...
                          <div class="col-md-6 col-xs-6">
                            <ul class="nav">
                              ...
                              <li><a href="<?=base_url()?>material-on-rolls/fluorescent-green-paper/">Fluorescent Colours - Paper</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/matt-white-dissolving-paper/">Matt White Dissolving - Paper</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/matt-white-fabric-friendly-paper/">Fabric Friendly - Paper</a></li>
                              <li class="request-free-sample"><a href="<?=base_url()?>sample-request/rolls/">Request Free Material Samples</a></li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-6 col-xs-6">
                            <ul class="nav">
                              ...
                              <li><a href="<?=base_url()?>material-on-rolls/matt-white-pvc/">Security Materials - PVC</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/matt-white-polypropylene/">Matt White - Polypropylene</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/semi-gloss-white-paper/">Semi Gloss White - Paper</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/gloss-white-inkjet-paper/?code=GWIP">Gloss White - Inkjet Paper</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/gloss-white-polypropylene/?code=PGWP">Gloss White - Polypropylene</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/gloss-white-inkjet-polypropylene/">Gloss White - Inkjet Polypropylene</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/high-gloss-white-paper/">High Gloss White - Paper</a></li>
                            </ul>
                          </div>
                          <div class="col-md-6 col-xs-6">
                            <ul class="nav">
                              <li><a href="<?=base_url()?>material-on-rolls/frozen-quartz-paper/">Pearlescent Finish - Paper</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/matt-white-opaque-paper/?code=MOP">Blockout/Cover-Up - Paper</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/gloss-clear-polypropylene/">Clear - Polypropylene</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/matt-gold-paper/">Metallic Colours - Paper</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/coated-bright-silver-polypropylene/">Metallic Colours - Polypropylene</a></li>
                              <li><a href="<?=base_url()?>material-on-rolls/matt-yellow-paper/">Matt Colours - Paper</a></li>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-5 col-xs-4">
                            <ul class="nav">
                              ...
                              <li><a href="<?=base_url()?>thermal-printer-roll-labels/">See all Thermal Printer Models</a></li>
                              <li class="request-free-sample"><a href="<?=base_url()?>sample-request/rolls/">Request Free Material Samples</a></li>
                            </ul>
                          </div>
                        </div>
          ...
          <div class="dropdown-menu mega-dropdown-menu">
            <div class="row">
              <div class="col-sm-4">
                ...
                <ul class="nav">
                  <li><a href="<?=base_url()?>printed-labels/rectangle/">Rectangle <img alt="Printed Rectangle Labels" class="pull-right" src="<?=Assets?>images/search_template/rect.png"></a></li>
                  <li><a href="<?=base_url()?>printed-labels/square/">Square <img alt="Printed Square Labels" class="pull-right" src="<?=Assets?>images/search_template/squre.png"></a></li>
                  <li><a href="<?=base_url()?>printed-labels/circular/">Circle <img alt="Printed Circle Labels" class="pull-right" src="<?=Assets?>images/search_template/circle.png"></a></li>
                  <li><a href="<?=base_url()?>printed-labels/star/">Star <img alt="Printed Star Labels" class="pull-right" src="<?=Assets?>images/search_template/star.png"></a></li>
                  <li><a href="<?=base_url()?>printed-labels/heart/">Heart <img alt="Printed Heart Labels" class="pull-right" src="<?=Assets?>images/search_template/heart.png"></a></li>
                  <li><a href="<?=base_url()?>printed-labels/oval/">Oval <img alt="Printed Oval Labels" class="pull-right" src="<?=Assets?>images/search_template/oval.png"></a></li>
                  <li><a href="<?=base_url()?>printed-labels/irregular/">Irregular <img alt="Printed Irregular Labels" class="pull-right" src="<?=Assets?>images/search_template/irr.png"></a></li>
                  <li><a href="<?=base_url()?>printed-labels/triangle/">Triangle <img alt="Printed Triangle Labels" class="pull-right" src="<?=Assets?>images/search_template/triangle.png"></a></li>
                  <li><a href="<?=base_url()?>printed-labels/anti-tamper/">Tamper Evident<img alt="Printed Tamper Evident Labels" class="pull-right" src="<?=Assets?>images/search_template/anti_temper.png"></a></li>
                  <li><a href="<?=base_url()?>printed-labels/perforated/">Perforated <img alt="Printed Perforated Labels" class="pull-right" src="<?=Assets?>images/search_template/triple.png" width="22"></a></li>
                </ul>
              </div>
              <div class="col-sm-8">
                <h6> </h6>
                <div class="ad-box">
                  <div class="ad-bg ad-h310 label-printed">
                    ...
                    <div class="ad-content" style="left: 288px;background: none;">
                      <hgroup>
                        <h4 class="blue" style="font-size:22px; color:#fd4913;">LOWEST ONLINE <br>
                          PRICE GUARANTEE</h4>
                      </hgroup>
                    </div>
                  </div>
                    ...
                    <div class="dropdown-menu mega-dropdown-menu">
                        <div class="row thumb-nav">
                            ...
                            <div class="col-xs-6 col-sm-3 col-md-2"><a
                                    ...
                                    <p> Honey <span>Jar Labels</span></p>
                                </a></div>
                            <div class="col-xs-6 col-sm-3 col-md-2"><a
                                    ...
                                    <p> Condiment <span>Jar Labels</span></p>
                                </a></div>
                            <div class="col-xs-6 col-sm-3 col-md-2"><a
                                    ...
                                    <p> Pickle & Sauces<span>Jar Labels</span></p>
                                </a></div>
                            <div class="col-xs-6 col-sm-3 col-md-2"><a
                                    ...
                                    <p> Candle & Diffuser <span>Jar Labels</span></p>
                                </a></div>
                            <div class="col-xs-6 col-sm-3 col-md-2"><a
                                    ...
                                    <p> Bathing Products <span> Labels</span></p>
                                </a></div>
                        </div>
                        <div class="row thumb-nav">
                            <div class="col-xs-6 col-sm-3 col-md-2"><a
                            ...
                            <div class="col-xs-6 col-sm-3 col-md-2">
                                ...
                                <a
                                    ...
                                    <p> Dried Food <span> Labels</span></p>
                                </a></div>
                            <div class="col-xs-6 col-sm-3 col-md-2">
                        <!--<?= base_url(); ?>free-label-design-templates/bags-sachets-boxes/dried-herbs-->
                                <a
                                    ...
                                    <p> Dried Herbs <span>Labels</span></p>
                                </a></div>
                        </div>
                    </div>
                </li>
          ...
          <div class="dropdown-menu mega-dropdown-menu">
            <div class="row">
              <div class="col-sm-4">
                ...
                <ul class="nav">
                  <li><a href="<?=base_url()?>custom-label-tool/rectangle/">Rectangle <img alt="Design Rectangle Labels" class="pull-right" src="<?=Assets?>images/search_template/rect.png"></a></li>
                  <li><a href="<?=base_url()?>custom-label-tool/square/">Square <img alt="Design Square Labels" class="pull-right" src="<?=Assets?>images/search_template/squre.png"></a></li>
                  <li><a href="<?=base_url()?>custom-label-tool/circular/">Circle <img alt="Design Circle Labels" class="pull-right" src="<?=Assets?>images/search_template/circle.png"></a></li>
                  <li><a href="<?=base_url()?>custom-label-tool/star/">Star <img alt="Design Star Labels" class="pull-right" src="<?=Assets?>images/search_template/star.png"></a></li>
                  <li><a href="<?=base_url()?>custom-label-tool/heart/">Heart <img alt="Design Heart Labels" class="pull-right" src="<?=Assets?>images/search_template/heart.png"></a></li>
                  <li><a href="<?=base_url()?>custom-label-tool/oval/">Oval <img alt="Design Oval Labels" class="pull-right" src="<?=Assets?>images/search_template/oval.png"></a></li>
                  <li><a href="<?=base_url()?>custom-label-tool/irregular/">Irregular <img alt="Design Irregular Labels" class="pull-right" src="<?=Assets?>images/search_template/irr.png"></a></li>
                  <li><a href="<?=base_url()?>custom-label-tool/triangle/">Triangle <img alt="Design Triangle Labels" class="pull-right" src="<?=Assets?>images/search_template/triangle.png"></a></li>
                  <li><a href="<?=base_url()?>custom-label-tool/anti-tamper/">Tamper Evident <img alt="Design Tamper Evident Labels" class="pull-right" src="<?=Assets?>images/search_template/anti_temper.png"></a></li>
                  <li><a href="<?=base_url()?>custom-label-tool/perforated/">Perforated <img alt="Design Perforated Labels" class="pull-right" src="<?=Assets?>images/search_template/triple.png" width="22"></a></li>
          ...
          <div class="dropdown-menu mega-dropdown-menu">
            <div class="row thumb-nav"> 
              ...
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/rectangle/">
                <div class="thumb-box"> <img alt="Rectangle Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-01.png" > </div>
                <p> Rectangle <span><small>(
                  392
                  Templates)</small></span> </p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/circular/">
                <div class="thumb-box"> <img alt="Circle Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-02.png" > </div>
                <p> Circle <span><small>(
                  47
                  Templates)</small></span> </p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/square/">
                <div class="thumb-box"> <img alt="Square Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-03.png" > </div>
                <p> Square <span><small>(
                  25
                  Templates)</small></span> </p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/oval/">
                <div class="thumb-box"> <img alt="Oval Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-04.png" > </div>
                <p> Oval <span><small>(
                 14
                  Templates)</small></span> </p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/star/">
                <div class="thumb-box"> <img alt="Star Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-05.png" > </div>
                <p> Star <span><small>(
                 1
                  Templates)</small></span> </p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/heart/">
                <div class="thumb-box"> <img alt="Heart Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-06.png" > </div>
                <p> Heart <span><small>(
                  8
                  Templates)</small></span> </p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/irregular/">
                <div class="thumb-box"> <img alt="Irregular Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-07.png" > </div>
                <p> Irregular  <span><small>(
                  25
                  Templates)</small></span></p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/triangle/">
                <div class="thumb-box"> <img alt="Triangle Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-08.png" > </div>
                <p> Triangle  <span><small>(
                  3
                  Templates)</small></span></p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/anti-tamper/">
                <div class="thumb-box"> <img alt="Tamper Evident Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-09.png" > </div>
                <p> Tamper Evident  <span><small>(
                  8
                  Templates)</small></span></p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>templates/perforated/">
                <div class="thumb-box"> <img alt="Perforated Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-10.png" > </div>
                <p> Perforated <span><small>(
                  4
                  Templates)</small></span> </p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>avery-sized-labels/">
                <div class="thumb-box"> <img alt="Avery® Sized Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-11.png" > </div>
                <p> Avery® Sized <span><small>(17 Templates)</small></span> </p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-2"> <a href="<?=base_url()?>customlabels.php/">
                <div class="thumb-box"> <img alt="Custom Sized Templates" class="img-responsive" src="<?=Assets?>images/icon_shape-12.png" > </div>
          ...
          <div class="dropdown-menu mega-dropdown-menu integrated_menu_dropdown">
            <div class="row thumb-nav integrated-thumb-nav"> 
              ...
              <div class="col-xs-6 col-sm-3 col-md-3"> <a href="<?=base_url()?>single-integrated-labels/">
                <div class="thumb-box"> <img alt="Single Integrated Labels" class="img-responsive" src="<?=Assets?>images/single_integrated.png" > </div>
              ...
              <div class="col-xs-6 col-sm-3 col-md-3"> <a href="<?=base_url()?>double-integrated-labels/">
                <div class="thumb-box"> <img alt="Double Integrated Labels" class="img-responsive" src="<?=Assets?>images/double_integrated.png" > </div>
              ...
              <div class="col-xs-6 col-sm-3 col-md-3"> <a href="<?=base_url()?>triple-integrated-labels/">
                <div class="thumb-box"> <img alt="Triple Integrated Labels" class="img-responsive" src="<?=Assets?>images/tripple_integrated.png" > </div>
                <p> Triple Integrated Labels <span><small>(2 Templates)</small></span> </p>
                </a> </div>
              <div class="col-xs-6 col-sm-3 col-md-3"> <a data-toggle="tooltip-integrated" data-placement="bottom" class="laser_printer_div" title="" data-original-title="(A range of full A4 sheet labels with a removable section in the position indicated)" href="<?=base_url()?>full-sheet-integrated-labels/">
                <div class="thumb-box"> <img alt="Full Sheet Delivery Labels" class="img-responsive" src="<?=Assets?>images/full_integrated.png" > </div>
                <p> Full Sheet Delivery Labels <i class="fa fa-question-circle"></i><span><small>(9 Templates)</small></span> </p>
                </a><small></small> </div>
            </div>
            ...
            <div class="row compatible_list">
              ...
              <div class="m-t-10 image-t-15">
                ...
                <div class="col-xs-6 col-md-2 ">
                  <div style="height:50px;" class=""> <a rel="noindex" href="<?=base_url()?>integrated-labels/<?=str_replace(" ","-",strtolower($row->name))?>/"> <img alt="Compatible with <?=$row->name?>" width="auto" height="auto" src="<?=Assets?>images/icons/<?=$row->image?>" class="img-responsive"> </a> </div>
                </div>
                <? } ?>
              </div>
            </div>
        ...
        <li class="promotion_menu"> <a href="<?=base_url()?>promotions/" class="" data-url="<?=base_url()?>promotions/">Promotions</a></li>
