...
<table width="632px" border="0" cellspacing="0" cellpadding="0" align="center" style="font-family:Arial;">
  ...
  <tr>
    <td bgcolor="#17b1e3" align="center" style="padding: 40px 5px;"><h1 style="font-size: 32px;color: #fff;font-family: Arial, sans-serif;font-weight: normal;">UNUSED DESIGNS</h1>
      <p style="font-size: 17px;color: #fff;font-family: Arial, sans-serif;font-weight: normal;"> proceed to checkout</p></td>
  </tr>
  <tr>
    <td bgcolor="#e9e8e8" style="text-align: center;font-size: 15px;font-weight: bold;color: #006da4;padding: 8px;font-family: Arial, sans-serif;"> UNUSED DESIGNS </td>
  </tr>
  ...
  <? foreach($cart_detail as $row){
	    ...
	    $designdata = $this->home_model->get_user_lba_data($row->saved_id);	
  ...
  <tr>
    ...
    <a href="<?=$complete_link?>" target="_blank"><?=$designdata['Name']?> 
