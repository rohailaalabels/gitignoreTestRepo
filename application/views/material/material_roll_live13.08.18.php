...
<div id="aa_loader" class="white-screen hidden-xs" style="display:none;">
  <div class="loading-gif text-center" style="top:92%;"> <img src="<?=Assets?>images/loader.gif" class="image" style="width:160px; height:43px; "> </div>
</div>
<div class="">
...
<? 
	...
	if($details['Shape_upd'] == "Oval" || $details['Shape_upd'] == "oval"){ $LabelCorner = "N/A";}
	else{ $LabelCorner = $details['LabelCorner'];}	
...
<div id="ajax_labelfilter" class="container">
  <div class="container mat-sep-2017">
    <div class="selected-product">
      <div class="row">
        <div id="prod_img" class="col-lg-2 col-md-2 col-sm-3 col-xs-3 pr-thumb"> <img id="wound_image" src="<?=$img_src?>" /> </div>
                ...
                <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                  <div class="row">
                    <div class=" labels-form col-lg-4 col-md-4 col-sm-4 col-xs-4">
                      <label class="select">
                        <select name="material" id="material_mat" onchange="fetch_category_mateials();">
                    ...
                    <div class=" labels-form  col-lg-4 col-md-4 col-sm-4 col-xs-4">
                      <label class="select">
                        <select name="color" id="color_mat" onchange="fetch_category_mateials();">
                    ...
                    <div class=" labels-form col-lg-4 col-md-4 col-sm-4 col-xs-4">
                      <label class="select">
                        <select name="adhesive" id="adhesive_mat" onchange="fetch_category_mateials();">
		...
		?>
            <div class="col-lg-4 col-md-4 hidden-sm hidden-xs printer-comp-detail">
              <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-4"><img class="img-responsive" alt="labels Image " src="<?=$src?>" height="155" width="185"></div>
              ...
              <div class="btns"> <a rel="nofollow" target="_blank" href="<?=base_url()?>download/usermanuals/<?=$printer_model['pdf']?>" 
                class="btn btn-sm orangeBg pull-left" role="button"><i class="fa fa-file-pdf-o"></i> User Manuals </a> <a rel="nofollow" target="_blank" href="<?=base_url()?>download/printer/<?=$printer_model['pdf']?>" class="btn btn-sm orangeBg pull-right" 
                role="button"> <i class="fa fa-file-pdf-o"></i> Product Datasheet </a> </div>
            </div>
            <? $printer_compatiblity = $printer_model['method']; }else{ ?>
            <input type="hidden" id="max_diameter" value="0" />
            <div class="col-lg-4 col-md-4 hidden-sm hidden-xs text-center why-seal"> <img class="img-responsive" src="<?=Assets?>images/30-icon.png">
              <div class="title m-t-10"> <a href="javascript:void(0);" data-toggle="popover" data-trigger="hover" data-placement="top" data-html="true"  
                        data-content="<div class='col-lg-12 col-md-12 frc-banner'><div class='title'> FAST, RELIABLE &amp; COST EFFECTIVE </div><ul><li>Over 80% of orders despatched same day</li><li>Daily despatch and delivery</li><li>Add the “Next Day” option to your order</li><li>If you need labels quicker, add a PRE 10:30 or 12:00 option for even faster delivery.</li><li>1,000’s of satisfied customers.</li><li>  <img src='<?=Assets?>images/iso_14001.png'> ISO9001 Certified</li><li><img src='<?=Assets?>images/iso_9001.png'> ISO14001 Certified</li> </ul></div>">Why Buy from AA Labels? <i class="fa fa-info-circle"></i></a> </div>
            </div>
            <? } ?>
      ...
      <div class="panel panel-default no-border mat-may-2017 <?=$class?>">
        <div class="panel-body no-padding">
          <div class="colors_data mat-ch append_search" id="<?=(isset($othermaterials) and $othermaterials!='')?'':'ajax_material_sorting'?>">
            <? if(isset($othermaterials) and $othermaterials!=''){$single_product = 'active';} include('material_list_view_roll.php'); ?>
          </div>
        </div>
      </div>
...
<div class="modal fade deactive_product" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
...
<div class="modal fade pbreaks aa-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content no-padding">
      <div class="panel no-margin">
        <div class="panel-heading">
          <h3 class="pull-left no-margin"><b>VOLUME PRICE BREAKS ROLL LABELS</b> <a href="#myModalLabel" class="anchorjs-link"><span class="anchorjs-icon"></span></a></h3>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times-circle"></i></button>
          <div class="clear"></div>
        </div>
        <div class="panel-body">
          <div class="text-center">
            <div id="price_loader" class="white-screen hidden-xs" style="display:none;">
              <div class="loading-gif text-center" style="top:26%;left:29%;"> <img src="<?=Assets?>images/loader.gif" class="image"> </div>
            </div>
...
$(document).on("change", "#woundoption", function(e) {
	...
	if(val!=''){
		...
		$('#prod_img').html('<img src="<?=Assets?>images/loader.gif" width="139" height="29" class="image" style="width:139px; height:29px; ">');
	 	request =  $.ajax({
                ...
                success: function(data){
				  if(val == 'Inside'){
						 setTimeout(function(){
								...
								$('#prod_img').html('<img id="wound_image" src="<?=Assets?>images/categoryimages/RollLabels/inside/<?=ltrim($details['DieCode'],"1-")?>'+material_code+'.jpg">');
					  ...
					  setTimeout(function(){
								...
								*/
								$('#prod_img').html('<img id="wound_image" src ="<?=Assets?>images/categoryimages/RollLabels/outside/<?=ltrim($details['DieCode'],"1-")?>'+material_code+'.jpg">');
...
function fetch_category_mateials(){
		...
		$.ajax({
			...
			data: {  
				...
				disablecontent:'disable',productid:productid,
