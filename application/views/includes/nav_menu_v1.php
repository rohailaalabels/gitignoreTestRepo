                    ...
                    <div class="row">
                      <div class="col-sm-6 col-xs-6">
                        ...
                        <ul class="nav">
                          ...
                          <li><a href="<?=base_url()?>material-on-rolls/fluorescent-red-paper/">Flourescent Colours</a></li>
                      ...
                      <div class="col-sm-6 col-xs-6">
                        ...
                        <ul class="nav">
                          <li><a href="<?=base_url()?>material-on-rolls/matt-white-polyethylene?code=PETH">Temperature Resistant</a></li>
                        </ul>
                        <label>Direct Thermal Paper</label>
                        <ul class="nav">
                    ...
                    <div class="row">
                      <div class="col-sm-6 col-xs-6">
                        ...
                        <ul class="nav">
                          ...
                          <li><a href="<?=base_url()?>material-on-sheets/fluorescent-orange-paper/">Flourescent Colours</a>
                      ...
                      <div class="col-sm-6 col-xs-6">
                        ...
                        <ul class="nav">
                          ...
                          <li><a href="<?=base_url()?>material-on-sheets/gloss-clear-polypropylene/">Gloss Clear</a></li>
                        ...
                        <div class="row">
                          <div class="col-md-6 col-xs-6">
                            <ul class="nav">
                              ...
                              <li><a href="<?=base_url()?>material-on-sheets/fluorescent-pink-paper/">Fluorescent Colours - Paper</a></li>
                        ...
                        <div class="row">
                          <div class="col-md-6 col-xs-6">
                            <ul class="nav">
                              ...
                              <li><a href="<?=base_url()?>material-on-rolls/fluorescent-orange-paper/">Fluorescent Colours - Paper</a></li>
                              <li class="request-free-sample"><a href="<?=base_url()?>sample-request/rolls/">Request Free Material Samples</a></li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 col-xs-6">
                            <ul class="nav">
                              ...
                              <li><a href="<?=base_url()?>material-on-rolls/fluorescent-pink-paper/">Fluorescent Colours - Paper</a></li>
                              <li class="request-free-sample"><a href="<?=base_url()?>sample-request/rolls/">Request Free Material Samples</a></li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div class="ad-bg ad-h310 label-printed">
                    <div class="ad-content">
                      <hgroup>
                        ...
                        <h5 class="d-blue">Search Options</h5>
                      </hgroup>
                      <p> To begin a search for printed label options simply select the label shape and enter to follow the easily navigable process. </p>
                      <p> If you need assistance there is the Live Chat option on the screen, or you can call and speak with one of our customer care team. </p>
                      <p> <a href="<?=base_url()?>printed-labels/" class="btn orangeBg">Search Online Now <i class="fa fa-arrow-circle-right"></i></a> </p>
                    </div>
                  </div>
                </div>
              </div>
