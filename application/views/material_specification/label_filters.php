        ...
        <div class="thumbnail orange-bottom no-margin no-padding-bottom" style="min-height: 73px;">
            ...
            <form id="filter-form" class="labels-form labels-filters-form  m-t-10">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="ChooseShapesMain">
                            <div class="ChooseShapes" style="width:100%;">
                                <h3 class="group_name"
                                    style="font-size: 18px;color: #006da4;font-weight: bold;margin: 0 0 10px 0;">Choose
                                    a Shape</h3>
                                ...
                                <div class="LabelWidthMain" id="width_box">
                                    <div class="LabelWidthHeader text-center" id="width_box_text"> LABEL WIDTH (mm)
                                    </div>
                                    <div class="LabelMain">
                                        ...
                                        <div class="clearfix rangelimit">
                                            ...
                                            <div class="col-xs-6 text-right"><small class="width_upperlimit">0</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="LabelHeightMain" id="height_box">
                                    ...
                                    <div class="LabelMain">
                                        ...
                                        <div class="clearfix rangelimit">
                                            <div class="col-xs-6 text-left"><small class="height_lowerlimit">0</small>
                                            </div>
                                ...
                                <div class="WidthHightCheckbox">
                                    <label class="check">Include opposite dimensions in the search criteria e.g. Height
                                        for Width
                                ...
                                <div class="selected-product">
                                    ...
                                    <div class="row selected-mat m-t-10" style="display:flex;">
                                        <div class="col-lg-5 col-md-5 col-sm-3 col-xs-4 pr-thumb text-center">
                                            <? if ($category == 'Roll') {
                                                $imagepath = Assets . 'images/material_images/roll/' . $info['material_code'] . '.png';
                                            } else {
                                                $imagepath = Assets . 'images/material_images/sheets/' . $info['material_code'] . '.png';
                                            }
                                            ?>
                                            <img onerror='imgError(this);' src="<?= $imagepath ?>"
                                                 alt="<?= $info['short_name'] ?>" class="sm-th img-responsive"/></div>
                                        <div class="col-lg-7 col-md-7 col-sm-9 col-xs-8">
                                            ...
                                            <div class="pr-detail">
                                                ...
                                                <a href="#" id="<?= $productid ?>" class="technical_specs_header"
                                                   data-target=".material" data-toggle="modal"
                                                   data-original-title="Tecnial Specification"> <i
                                                            class="fa fa-info-circle"></i> View Material
                                                    Specification</a>
                                                <div class="clear10"></div>
                                                <?php
                                                $url = base_url() . $this->uri->segment(1) . "/" . $this->uri->segment(2);
                                                ?>
                                                <button class="btn blue2 pull-right edit_material_option" type="button"
                                                        data-url="<?= $url ?>"><i class="fa fa-pencil-square-o"
                ...
                <div class="clearfix">
                    ...
                    <div class="SectionLeft col-md-6"></div>
                </div>
                <div class="clearfix">
