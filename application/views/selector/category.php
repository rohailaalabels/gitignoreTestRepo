                        ...
                        <? if (preg_match("/Roll/", $pro->CategoryName)) { ?>
                            <div class="labels-form">
                                <div class="btn-group btn-block dm-selector"><a id="coresize_<?= $pro->CategoryID ?>"
                                                                                class="btn btn-default btn-block dropdown-toggle coresize"
                                                                                data-toggle="dropdown" data-value="">
                                        Select Core Size <i class="fa fa-unsorted"></i></a>
                            ...
                            <a data-prd-id="roll" data-cat-id="<?= $pro->CategoryID ?>" id="<?= $pro->CategoryID ?>"
                               ...
                               href="<?= $url ?>"> <i class="fa fa-arrow-circle-right"></i> Select </a>
                        <? } else {
                            ...
                            ?>
                            <a role="button" class="btn-block btn orange <?= $wholesale_class ?> load_flash"
                               data-temp_id="<?= $pro->ProductID ?>"> <i class="fa fa-arrow-circle-right"></i> Select
                                Template </a>
                        <? } ?>
                    </div>
                </div>
