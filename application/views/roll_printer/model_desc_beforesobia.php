    ...
    <div class="thumbnail ">
        ...
        <div class="col-sm-5 m-t-10">
            <div class="caption2">
                ...
                <div class="row">
                    <p class="col-md-6"><strong>Maximum Print Size</strong><br>
                        <?= $printer_model['PrintWidth'] ?>
                        mm</p>
                    <p class="col-md-6"><strong>Maximum Roll Diameter</strong><br>
                        <?= $printer_model['RollDiamter'] ?>
                        mm</p>
                    <p class="col-md-6"><strong>Core Size</strong><br>
                        <?= $printer_model['coresize'] ?>
                    </p>
                    <p class="col-md-6"><strong>Compatibility</strong><br>
                        <?= $printer_model['method'] ?>
                    </p>
                </div>


                <!--<a rel="nofollow" href="<?= base_url() ?>download/printer/<?= $printer_model['pdf'] ?>" class=" col-xs-12 btn orangeBg" role="button">
      <i class="fa fa-file-pdf-o"></i> Product Data Sheet </a> -->

                <a rel="nofollow" href="<?= base_url() ?>download/printer/<?= $printer_model['pdf'] ?>"
                   class="col-xs-5 btn orangeBg pull-right" role="button">
                    <i class="fa fa-file-pdf-o"></i> Product Datasheet
                </a>
                <a rel="nofollow" href="<?= base_url() ?>download/usermanuals/<?= $printer_model['pdf'] ?>"
                                    ...
                                    <div class="item active ">
                                        <div>
                                            <p class="text-justify"><small>
                                                    To get the best results from your label printing and achieve a
                                                    consistent print quality, how you store labels is
                                            ...
                                            <ul>
                                                <li><small>
                                                        Always store your labels in a clean dry environment between 5 –
                                                        30C (ideally 22C +/- 2C) and a relative humidity of 50% +/-5%.
