...
<div class="printed-lba-a4 ">
    <div class="container ">
        <div class="col-md-8 col-sm-12  m-t-30  ">
            <h1>CUSTOM LABELS – SHAPE & SIZE</h1>
        ...
        <div class="col-md-4 col-sm-12 "><img onerror='imgError(this);' class="img-responsive"
                                              ...
                                              alt="AA Labels Custom Labels"></div>
    </div>
</div>
<div class="bgGray">
    <div class="container">
                    ...
                    <div class="m-t-15 col-md-12 ">
                        ...
                        <div>
                            ...
                            <p>If none of the labels from our standard range are suitable for your purpose, then we will
                                ...
                                your artwork in a number of file formats and can provide design assistance if
                                required. </p>
                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <label class="input">
                                            <input type="text" name="width" id="width" placeholder="Width mm"
                                                   class="required sizespecialvalidation">
                                        </label>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="input">
                                    ...
                                    <div class="col-md-12">
                                        <label class="input">
                                            <textarea placeholder="Enter Other Instructions ....." rows="3"
                                                      class="form-control specialvalidation" name="subject" id="subject"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-xs-6 col-sm-8">
                                            <input id="file_up" class="m-t-15" style="display:none;" type="file"
                                                   name="file_up" accept="image/x-png,image/gif,image/jpeg,application/pdf">
                                        </div>
                                        ...
                                        <div class="">
                                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                                <input type="text" placeholder="Full Name" name="name" id="name"
                                                       class="required letters">
                                            </label>
                                        </div>
                                        <div class="">
                                            <label class="input"> <i class="icon-append fa fa-envelope"></i>
                                                <input type="text" placeholder="Email" name="email" id="email"
                                                       class="required emailspecialvalidation">
                                            </label>
                                        </div>
                                        <div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 p0  ">
                                            <label class="input">
                                                <input type="text" placeholder="Postcode" name="b_pcode" id="b_pcode"
                                                       class="required specialvalidation">
                                        ...
                                        <div class="col-xs-12 col-sm-12 p0  ">
                                            <label class="input"> <i class="icon-append fa fa-briefcase"></i>
                                                <input type="text" placeholder="Company" name="company"
                                                       id="b_organization" class="required specialvalidation">
                                            </label>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 p0  ">
                                            <label class="input"> <i class="icon-append fa fa-map"></i>
                                                <input type="text" id="b_add1" name="add1" value=""
                                                       placeholder="Address1" class="required addressspecialvalidation">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 ">
                                        <div>
                                            <label class="input"> <i class="icon-append fa fa-map"></i>
                                                <input type="text" id="b_add2" name="add2" value=""
                                                       placeholder="Address2" class="addressspecialvalidation">
                                            </label>
                                        </div>
                                        <div>
                                            <label class="input"> <i class="icon-append fa fa-map"></i>
                                        ...
                                        <div>
                                            <label class="input"> <i class="icon-append fa fa-map"></i>
                                                <input type="text" id="b_county" name="county" value=""
                                                       placeholder="County" class="required specialvalidation">
                                            </label>
                                        </div>
                                        <div class=" ">
                                            <div>
...
<div class="printed-lba-call ">
    <div class="container ">
        ...
        <div class="col-md-4 col-sm-4 col-lg-3 hidden-xs "><img onerror='imgError(this);' class="img-responsive"
...
<script>
    ...
    $(document).on("keypress keyup blur", ".letters", function (e) {
	 ...
	 $(document).on("keypress", ".specialvalidation", function(e) {
       ...
       $(document).on("keypress", ".sizespecialvalidation", function(e) {
          var keyCode = e.which;
