<table class="table table-striped labels-form " style="border:solid 2px #00aeef;">
    ...
    <? if ($max['q1'] == 0) {
        ...
        <tr class="checklist" valign="middle">
            ...
            <td><label class="checkbox">
                    ...
                    <i></i></label></td>
            <td align="left"><textarea name="feedback[q1_text]" rows="1" class="form-control description"></textarea>
            </td>
        </tr>
    <? } else { ?> <input name="feedback[q1]" class="textOrange approve hide" value="1" type="radio"
                          checked="checked"/> <? } ?>
    ...
    <? if ($max['q2'] == 0) {
        ...
        <tr class="checklist" valign="middle">
            <td align="left"><?= $item ?></td>
            <td align="left">Is the content information correct e.g. Asset codes, bar codes, contact details, dates,
                ingredients, prices etc?
            </td>
            <td><label class="checkbox">
            ...
            <td><label class="checkbox">
                    ...
                    <i></i></label></td>
            <td align="left"><textarea name="feedback[q2_text]" rows="1" class="form-control description"></textarea>
            </td>
        </tr>
    <? } else { ?> <input name="feedback[q2]" class="textOrange approve hide" value="1" type="radio"
                          checked="checked"/> <? } ?>
    ...
    <? if ($max['q3'] == 0) {
        ...
        <tr class="checklist" valign="middle">
            ...
            <td><label class="checkbox">
                    ...
                    <i></i></label></td>
            <td align="left"><textarea name="feedback[q3_text]" rows="1" class="form-control description"></textarea>
            </td>
        </tr>
    <? } else { ?> <input name="feedback[q3]" class="textOrange approve hide" value="1" type="radio"
                          checked="checked"/> <? } ?>
    ...
    <? if ($max['q4'] == 0) {
        ...
        <tr class="checklist" valign="middle">
            <td align="left"><?= $item ?></td>
            <td align="left">Is the alignment and ratio of the artwork correct e.g. As supplied and/or amended and
                agreed?
            </td>
            <td><label class="checkbox">
            ...
            <td><label class="checkbox">
                    ...
                    <i></i></label></td>
            <td align="left"><textarea name="feedback[q4_text]" rows="1" class="form-control description"></textarea>
            </td>
        </tr>
    <? } else { ?> <input name="feedback[q4]" class="textOrange approve hide" value="1" type="radio"
                          checked="checked"/> <? } ?>
    ...
    <? if ($max['q5'] == 0) {
        ...
        <tr class="checklist" valign="middle">
            ...
            <td><label class="checkbox">
                    ...
                    <i></i></label></td>
            <td align="left"><textarea name="feedback[q5_text]" rows="1" class="form-control description"></textarea>
            </td>
        </tr>
    <? } else { ?> <input name="feedback[q5]" class="textOrange approve hide" value="1" type="radio"
                          checked="checked"/> <? } ?>
    ...
    <? if (preg_match('/roll/is', $result['ProductName'])) { ?>
        ...
        <? } else { ?> <input name="feedback[q6]" class="textOrange approve hide" value="1" type="radio"
                              checked="checked"/> <? } ?>
        ...
        <? } else { ?> <input name="feedback[q7]" class="textOrange approve hide" value="1" type="radio"
                              checked="checked"/> <? } ?>
