<div class="thumbnail">
    <div class="row  dm-row">
        <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12  dm-box">
            <div class="thumbnail">
                <div class="clear10"></div>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-6 col-xs-12"><a href="javascript:void(0);"
                                                           class="btn-block btn blue2 step-back" data-value="1"
                                                           role="button"> <i class="fa fa-arrow-circle-left"></i> Back
                                to Shape & Size </a></div>
                    </div>
                </div>
                <div class="clear10"></div>
                <div class="col-xs-12">
                    <p class="text-justify">Select the label material and finish required along with the adhesive type
                    ...
                    <div class="row srl  m-t-30">
                        <div id="roll_material_selection" class="col-lg-6 col-md-6 col-sm-12 sfr m-b-10 matselector"
                             style="display:none;">
                            ...
                            <div class="labels-form">
                                ...
                                <div class="btn-group btn-block dm-selector material-d-down"><a
                                            class="btn btn-default btn-block dropdown-toggle" data-toggle="dropdown">Select
                                        Label Material <i class="fa fa-unsorted"></i></a>
                                ...
                                <div class="btn-group btn-block dm-selector color-d-down"><a
                                            class="btn btn-default btn-block dropdown-toggle" data-toggle="dropdown">Select
                                        Label Colour <i class="fa fa-unsorted"></i></a>
                                    <ul class="dropdown-menu btn-block mega-print-dd-menu">
                                    </ul>
                                </div>
                                <div class="clear15"></div>
                                <div class="btn-group btn-block dm-selector adhesive-d-down"><a
                                            class="btn btn-default btn-block dropdown-toggle" data-toggle="dropdown">Select
                                        Label Adhesive <i class="fa fa-unsorted"></i></a>
                                    <ul class="dropdown-menu btn-block">
                                    </ul>
                                </div>
                                <div class="clear15"></div>
                                ...
                                <!--<label class="select">
                                   <select name="digital_proccess" class="nlabelfilter">
                                     <option selected="selected" value="">Select Digital Printing Process</option>
                                      <option value="Black Only">Black Only</option>
                                      <option value="Full Colour">Full Colour</option>
                                      <option value="Full Colour + White">Full Colour + White</option>
                                    </select>
                                    <i></i>
                                  </label>-->

                                <div class="btn-group btn-block dm-selector digital_proccess-d-down"><a
                                            class="btn btn-default btn-block dropdown-toggle" data-toggle="dropdown">Select
                                        Digital Print Process (Rolls) <i class="fa fa-unsorted"></i></a>
                                    <ul class="dropdown-menu btn-block">
                                        <li><a data-toggle="tooltip-digital" data-trigger="hover" data-placement="left"
                                               title="" data-value="" data-id="digital"> Select Digital Print Process
                                                (Rolls) </a></li>
                                        <?php
                        ...
                        <div id="a4_material_selection" class="col-lg-6 col-md-6 col-xs-12 sfl matselector">
                            <div class="title col-xs-12 no-padding">
                            ...
                            <div class="labels-form">
                                ...
                                <div class="btn-group btn-block dm-selector digital_proccess-d-down"><a
                                            class="btn btn-default btn-block dropdown-toggle" data-toggle="dropdown">Select
                                        Digital Print Process (Sheets) <i class="fa fa-unsorted"></i></a>
                                    <ul class="dropdown-menu btn-block">
                                        <li><a data-toggle="tooltip-digital" data-trigger="hover" data-placement="left"
                                               title="" data-id="digital" data-value="">Select Digital Print Process
                                                (Sheets) </a></li>
                                        <?php
                        ...
                        <div id="empty_material_selection" class="col-lg-6 col-md-6 col-xs-12 sfl m-b-20">
                            <div style="margin-top:36px; ">
                                <div class="img-responsive"><img onerror='imgError(this);' class="img-responsive"
                                                                 src="<?= Assets ?>images/categoryimages/labelShapes/aqua.png"
                                                                 alt="Printed labels banner"></div>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="clear"></div>
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6 col-xs-12 pull-right">
                                    <button class="btn-block btn orangeBg step-forward" data-value="3"> Proceed to
                                        Quantity & Prices <i class="fa fa-arrow-circle-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
            <div class="thumbnail lSum">
                ...
                <div class="col-xs-12">
                    <div class="title"><b class="col-xs-12">Label Summary</b> <span
                                class="col-sm-8 col-xs-12 text-right hide"></span></div>
                    <div class="thumb text-center labelsummary" style="min-height:188px;">
                        <!--<img onerror='imgError(this);' class="lbl_img_size" src="<?= Assets ?>images/lSummThumb.png"> -->
                    </div>
                    <div class="detail" style="min-height:285px;">
                        <div class="col-xs-6 col-xs-12 roll_material_selection">
                            <div class="sfr">
                                <div class="title">
                                    <div class="roll-icon pull-left"><img onerror='imgError(this);' class=""
                                                                          src="<?= Assets ?>images/categoryimages/labelShapes/printed_roll.png"
                                ...
                                <div class="clear10"></div>
                                <p><b>Code:</b> <span name="productcode_text"> - </span></p>
                                <p><b>Material:</b> <span name="material_text"> - </span></p>
                                <p><b>Colour:</b> <span name="color_text"> - </span></p>
                                <p><b>Adhesive:</b> <span name="adhesive_text"> - </span></p>
                                <p><b>Digital Process: </b><br/>
                                    <span name="digital_proccess_text"></span></p>
                                <p><b>Finish:</b> <span name="finish_text"> - </span></p>
                                <p><b>Label Size:</b><br/>
                                    <span class="labelsize"> - </span></p>
                            </div>
                        </div>
                        <div class="col-xs-6 col-xs-12 a4_material_selection">
                            <div class="sfl">
                                <div class="title">
                                    <div class="sheet-icon pull-left"><img onerror='imgError(this);' class=""
                                                                           src="<?= Assets ?>images/categoryimages/labelShapes/printed_sheet.png"
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab_colour">
                        ...
                        <div class="col-md-12 text-justify">
                            ...
                            <div class="clear10"></div>
                            <p> For more information please refer to the materials specifications page and/or speak with
