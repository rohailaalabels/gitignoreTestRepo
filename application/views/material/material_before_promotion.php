...
f<div id="aa_loader" class="white-screen" style=" display:none;" >
...
<?
	...
	if(preg_match("/SRA3/",$details['CategoryName'])){
				  ...
				  $popup_margin = 'margin:6px auto !important;'; $type = "SRA3";
	}
				  ...
				  $box_height = 'min-height:325px;';
				  $pop_width = '200';
				  $popup_margin = 'margin:6px auto !important;'; $type = "A3";
	}
	else{
  ...
  <div id="ajax_labelfilter" class="container">
    <div class="row">
      <div class="mat-sep-2017">
		...
		?>
          <div class="row">
            <div class="<?=$class1?> pr-thumb"> <img onerror='imgError(this);' src="<?=$img_src?>" alt="<?=$catname?>" title="<?=$catname?>" > </div>
            <div class="<?=$class2?>">
              <div class="row flexcontainer">
                  ...
                  <div class="pr-detail">
                    <table class="pr-table">
                      <tr>
                        ...
                        <td><b>Label Size: </b>
                          <?=$LabelSize?></td>
                        <td><a role="button" data-target=".layout" data-toggle="modal"> View Full Specification</a></td>
                      </tr>
                    </table>
                    <?php 
					if($type != "A3" and $type != "SRA3"):?>
                    <p class="<?=($compitable)?'':'av-comp'?> "><b>Compatible with Avery&reg; templates:</b>
					...
					?>
                    <div class="desktop_euro_div hidden-xs"> <img onerror='imgError(this);' src="<?=$thumbnail?>" alt="Dry Edge" style="margin-top: -5px;" class="euro_thumbnail pull-left"/>
                      <p class="euro_text_top">Our innovative dry-edge label sheets, have a small 1mm strip of label material and adhesive removed from around the edge of the sheet, <a href="javascript:void(0)" data-toggle="tooltip" title="Our innovative dry-edge label sheets, have a small 1mm strip of label material and adhesive removed from around the edge of the sheet, exposing the release liner and backing paper, creating a dry area that prevents problems associated with adhesive deposits on printer rollers. Enabling faster, problem free printing of sheet labels.">Read more</a></p>
                      <div class="req-links">
                        <div class="row">
                          <div class="col-xs-4 col-sm-3 text-left download-icons"> <a target="_blank" rel="nofollow" data-toggle="tooltip" title="Download PDF Template" href="<?=base_url()."download/pdf/".$details['pdfFile'];?>" role="button"> <img onerror='imgError(this);' src="<?=Assets?>images/pdf-icon.png" alt="PDF Icon"/> </a> <a target="_blank" data-toggle="tooltip"  title="Download Word Template" rel="nofollw" href="<?=Assets."images/office/word/".$details['WordDoc'];?>" role="button"> <img onerror='imgError(this);' src="<?=Assets?>images/word-icon.png" alt="MS Word Icon"/> </a> <a target="_blank"  data-toggle="tooltip" class="hidden-sm hidden-xs" title="Click here to view or design your template. (Open in new window)" rel="nofollw" 
                        href="<?=base_url().'custom-label-tool/designer/'.$productid.'/'?>" role="button"> <img onerror='imgError(this);' src="<?=Assets?>images/ld-icon.png" alt="Label Designer"/> </a> </div>
                          <div class="col-xs-8 col-sm-9 printer_top_div">
                            ...
                            <div class="comp">
                              <table class="table printer" border="0" style="border:none;">
                                <tbody>
                                  <tr>
                                    <td align="left" valign="center" style="font-size:12px; border:none;vertical-align: bottom;width:25%;"><small style="margin-top:10px;font-size:12px;">Printer<br />
                                      Compatibility</small></td>
                                    <td align="left" style="font-size:12px; border:none; width:25%;"> Laser <img onerror='imgError(this);' class="laser_printer_img" width="50" src="<?=Assets?>images/<?=$comp['laser_img']?>"  /><a data-toggle="tooltip-product" data-placement="top" class="laser_printer_div" title="" data-original-title="<?=$comp['laser_text']?>" href="javascript:void(0);"><i class="fa fa-info-circle"></i></a></td>
                                    <td align="left" style=" font-size:12px;border:none;width:25%;"> Inkjet <img onerror='imgError(this);' class="inkjet_printer_img" width="50" src="<?=Assets?>images/<?=$comp['inkjet_img']?>"  /><a data-toggle="tooltip-product" data-placement="top" title="" class="inkjet_printer_div" data-original-title="<?=$comp['inkjet_text']?>" href="javascript:void(0);"><i class="fa fa-info-circle"></i></a></td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 hidden-sm hidden-xs text-center why-seal"> <img onerror='imgError(this);' class="img-responsive" src="<?=Assets?>images/30-icon.png" alt="30 Days Moneyback Guarantee">
                  <div class="title m-t-10"> <a href="javascript:void(0);" data-toggle="popover" data-trigger="hover" data-placement="top" data-html="true"  
                        data-content="<div class='col-lg-12 col-md-12 frc-banner'><div class='title'> FAST, RELIABLE &amp; COST EFFECTIVE </div><ul><li>Over 80% of orders despatched same day</li><li>Daily despatch and delivery</li><li>Add the “Next Day” option to your order</li><li>If you need labels quicker, add a PRE 10:30 or 12:00 option for even faster delivery.</li><li>1,000’s of satisfied customers.</li><li>  <img onerror='imgError(this);' src='<?=Assets?>images/iso_14001.png'> ISO9001 Certified</li><li><img onerror='imgError(this);' src='<?=Assets?>images/iso_9001.png'> ISO14001 Certified</li> </ul></div>">Why Buy from AA Labels? <i class="fa fa-info-circle"></i></a> </div>
                </div>
              </div>
            </div>
            <?php if($this->agent->is_mobile()) {?>
            <div class="col-xs-12 mobile_euro_div hide visible-xs"> <img onerror='imgError(this);' src="<?=$thumbnail?>" alt="Dry Edge Sheets" style="margin-top: -5px;" class="euro_thumbnail pull-left"/>
              <p class="euro_text_top">Our innovative dry-edge label sheets, have a small 1mm strip of label material and adhesive removed from around the edge of the sheet, <a href="javascript:void(0)" data-toggle="tooltip" title="Our innovative dry-edge label sheets, have a small 1mm strip of label material and adhesive removed from around the edge of the sheet, exposing the release liner and backing paper, creating a dry area that prevents problems associated with adhesive deposits on printer rollers. Enabling faster, problem free printing of sheet labels.">Read more</a></p>
              <div class="req-links clear">
                <div class="row">
                  <div class="col-xs-3 col-sm-3 text-left download-icons"> <a rel="nofollow" target="_blank" data-toggle="tooltip" title="Download PDF Template" href="<?=base_url()."download/pdf/".$details['pdfFile'];?>" role="button"> <img onerror='imgError(this);' src="<?=Assets?>images/pdf-icon.png" alt="Download PDF Template"/> </a> <a data-toggle="tooltip" target="_blank" title="Download Word Template" rel="nofollw" href="<?=Assets."images/office/word/".$details['WordDoc'];?>" role="button"> <img onerror='imgError(this);' src="<?=Assets?>images/word-icon.png" alt="Download Word Template"/> </a> <a target="_blank"  data-toggle="tooltip" class="hidden-sm hidden-xs" title="Click here to view or design your template. (Open in new window)" rel="nofollw" 
                href="<?=base_url().'custom-label-tool/designer/'.$productid.'/'?>" role="button"> <img onerror='imgError(this);' src="<?=Assets?>images/ld-icon.png" alt="Label Desiger"/> </a> </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <p class="m-t-b-8"><small><strong>Disclaimer: </strong>AALabels products are not made or endorsed by Avery®. Avery® is a trademark of CCL Industries Inc., registered in the UK and other countries. References to Avery® are solely used to indicate compatibility for label sizes and templates.</small></p>
            </div>
          </div>
          <?php endif;?>
        </div>
              ...
              <div class="row flexcontainer">
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                  ...
                  <div class="pr-detail">
                    ...
                    <p> <a role="button" data-target=".layout" data-toggle="modal"> View Label Layout</a> </p>
                    <?php 
                    ...
                    <div class="req-links">
                      <div class="row">
                        <div class="col-xs-12 text-left download-icons"> <a rel="nofollow" target="_blank" data-toggle="tooltip" title="Download PDF Template" 
                      href="<?=base_url()."download/pdf/".$details['pdfFile'];?>" role="button"> <img onerror='imgError(this);'  style=" height:35px;" src="<?=Assets?>images/pdf-icon.png" /> </a> <a data-toggle="tooltip" target="_blank"  title="Download Word Template" rel="nofollw" 
                     href="<?=Assets."images/office/word/".$details['WordDoc'];?>" role="button"> <img onerror='imgError(this);'  style=" height:35px;" src="<?=Assets?>images/word-icon.png" /> </a> <a target="_blank"  data-toggle="tooltip" class="hidden-sm hidden-xs" title="Click here to view or design your template. (Open in new window)" rel="nofollw" 
                    href="<?=base_url().'custom-label-tool/designer/'.$productid.'/'?>" role="button"> <img onerror='imgError(this);'  style=" height:35px;" src="<?=Assets?>images/ld-icon.png" /> </a> </div>
                      </div>
                    </div>
                  </div>
                  <? if($filter!='disabled' and !$this->agent->is_mobile() and !isset($othermaterials)){?>
                ...
                <div class="col-lg-4 col-md-4 hidden-sm hidden-xs text-center why-seal"> <img onerror='imgError(this);' class="img-responsive" src="<?=Assets?>images/30-icon.png">
                  <div class="title m-t-10"> <a href="javascript:void(0);" data-toggle="popover" data-trigger="hover" data-placement="top" data-html="true"  
                        data-content="<div class='col-lg-12 col-md-12 frc-banner'><div class='title'> FAST, RELIABLE &amp; COST EFFECTIVE </div><ul><li>Over 80% of orders despatched same day</li><li>Daily despatch and delivery</li><li>Add the “Next Day” option to your order</li><li>If you need labels quicker, add a PRE 10:30 or 12:00 option for even faster delivery.</li><li>1,000’s of satisfied customers.</li><li>  <img onerror='imgError(this);' src='<?=Assets?>images/iso_14001.png'> ISO9001 Certified</li><li><img onerror='imgError(this);' src='<?=Assets?>images/iso_9001.png'> ISO14001 Certified</li> </ul></div>">Why Buy from AA Labels? <i class="fa fa-info-circle"></i></a> </div>
                </div>
              </div>
      ...
      <div class="<?=$class2?>">
	   ...
	   if(isset($othermaterials) and $othermaterials!=''){
        ...
        <div class="other_materials">
          <? if($filter!='disabled' and !$this->agent->is_mobile()){?>
          <div class="sort-filters hidden-xs filterBg p-l-r-10">
            <div class="row">
              <div class="col-md-2">
              ...
              <div class="col-md-10">
                <div class="row">
                  <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                    <div class="row">
                      <div class="labels-form col-lg-3 col-md-3 col-sm-3 col-xs-3"> <a href="javascript:void(0);" class="btn orangeBg btn-block promotion-styles" onclick="fetch_special_offers();">View Special Offer <i class="fa fa-gift"></i></a> </div>
								...
								function(isConfirm) {
								  if (isConfirm) {
											...
											$.ajax({
												...
												async:"false",
												dataType: "html",
												data: {  qty: qty,menuid: menuid,prd_id:product_id,labeltype:printing,cartid:cart_id,labels:labels},
												success: function(data){
												if(!data==''){  
														data = $.parseJSON(data); 
														if(data.response=='yes'){
...
function fetch_category_mateials(){
		...
		<?php endif;?>
		   ...
		   $.ajax({
							...
							async:"false",
							dataType: "html",
							data: {  material: material,adhesive: adhesive,color: color,catid: catid,productid:productid },
							success: function(data){
								if(!data==''){	
									data = $.parseJSON(data); 
