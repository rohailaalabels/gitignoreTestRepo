...
<div class="bgGray">
    ...
    <div class="setup-content" id="step-4">
                ...
                <div class="paymentInputs">
                    ...
                    <p class="m-t-10">
                        <label class="radio borderRadius ">
                            ...
                            <small> *(Government Offices &amp; Educational Establishments only)</small>
                        </label>
                    </p>
                    ...
                    <div id="uploader_po" style="display:none;">
                        ...
                        <div class="col-xs-4 col-sm-4  ">
                            <img onerror='imgError(this);' width="60" height="" style="display:none;"
                                 id="preview_po_img" src="#" alt="Preview Purchase Order"/>
                        </div>
                        <div class="clear10"></div>
                    </div>
        ...
        <div class="col-sm-12 ">
            ...
            <div class="col-sm-6 m-t-20 paymentInputs normal_checkout">

                <div class="col-sm-12  ">
                    <label class="checkbox"><input type="checkbox" name="confirm_check" value="yes" class="textOrange">
                        <i></i> Because our labels are produced to order, please tick the box to confirm that you have
                        checked your order carefully before proceeding to make payment.</label>
                </div>
                <div class="col-sm-12 ">
...
<script>
    ...
    $(document).on("change", "#dcountry", function (e) {
        ...
        if (deliverycountry.length > 0 && billingcountry != 'United Kingdom' && deliverycountry != 'United Kingdom') {
            $('.ukvatbox').show();
            $("input[name=unreg_vat]").prop("checked", false);
        } else {
    ...
    function update_review_address() {
        ...
        if (oldpcode != d_pcode || oldcountry != dcountry) {
            ...
            if (dcountry.length > 0 && country != 'United Kingdom' && dcountry != 'United Kingdom') {
            ...
            $.ajax({
                ...
                async: "false",
                dataType: "html",
                data: {postocde: d_pcode, country: dcountry, bpcode: b_pcode},
                success: function (data) {
                    if (!data == '') {
                        data = $.parseJSON(data);
