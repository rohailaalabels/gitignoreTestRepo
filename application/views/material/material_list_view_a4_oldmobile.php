                    ...
                    <div class="tab-content">
                     <div id="tab_plain<?=$rec->ProductID?>" class="tab-pane tabplain active" role="tabpanel">
                        <div class="row p-t-10">
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="row">
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center qty">
                                ...
                                <div class="row"> 
                               		<small class="small_plain_minqty_txt col-xs-6">Minimum order <?=$min_qty?> sheets</small> 
                                    <small class="col-xs-6 text-center">
                                        <a href="#" class="price_breaks" data-target=".pbreaks" data-toggle="modal" 
                                        data-original-title="Volume Price Breaks">View volume price breaks</a>
                                    </small> 
                                </div>
                              </div>
                            </div>
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 quotation">
                            ...
                            <button class="btn orangeBg pull-right calculate_plain" type="button">
                            	Calculate Price <i class="fa fa-calculator"></i> 
                            </button>
                          ...
                          <div class="col-xs-12 service text-right addprintingoption hide"> 
                          ...
                          <div class="col-xs-12 ofq">
                            ...
                            <div class="col-xs-4 main-box">
                              <div class="row">
                                ...
                                <div class="col-xs-10  no-padding-right"><b>Free Delivery on Orders over <?=symbol.$this->home_model->currecy_converter(25.00, 'no');?></b></div>
                              </div>
                            </div>
                            <div class="col-xs-4 main-box">
                              <div class="row">
                              ...
                              <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 m-t-15">
                                <div class="dm-box">
                                   <div class="btn-group btn-block dm-selector digital_proccess-d-down"> 
                                        ...
                                        <li>
                                            <a data-toggle="tooltip-digital" data-value="" data-trigger="hover" data-placement="left" title="" data-id="digital">
                                            Select Digital Print Process </a>
                                        </li>
                                   ...
                                   <table class="price" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                 ...
                                                 <tr class="desgincharge" style="">
                                                    <td style=" width:80%;" class="text-left phead">
                                                      Additional Designs <?=symbol.$this->home_model->currecy_converter(5.00, 'yes');?> each
                                                     </td>
                      ...
                      <div id="tab_sample<?=$rec->ProductID?>" class="tab-pane" role="tabpanel">
                            ...
                            <small> All material samples are supplied on A4 sheets for the purpose of assisting the choice of face-stock colour and appearance. Along with assessing the print quality and application suitability of the adhesive.</small>
