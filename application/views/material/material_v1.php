...
<div id="aa_loader" class="white-screen" style=" display:none;">
    <div class="loading-gif text-center" style="top:95%; z-index:150;"><img src="<?= Assets ?>images/loader.gif"
                                                                            class="image"
        ...
        <div class="row">
            <div class="mat-sep-2017">
                <div class="selected-product">
                    ...
                    <div class="row">
                      ...
                      <?= ltrim($details['DieCode'], "1-") ?>
                                        ...
                                        if ($type != "A3" and $type != "SRA3"):?>
                                            <p class="<?= ($compitable) ? '' : 'av-comp' ?> "><b>Compatible with Avery&reg;
                                                    templates:</b>
                                        ...
                                        <div class="req-links">
                                            ...
                                            <!--<p class="ddt">
                  	<a target="_blank" href="<?= base_url() . 'custom-label-tool/designer/' . $productid . '/' ?>">
                    <i class="fa fa-info-circle" aria-hidden="true"></i>Click here to view, design or download your template </a>
                  ...
                  <p class="ddt">
                  	<a target="_blank" href="<?= base_url() . 'custom-label-tool/designer/' . $productid . '/' ?>">
                    <i class="fa fa-info-circle" aria-hidden="true"></i> Click here to view or design your template </a>
                    <small>(Opens in new window)</small>
                   </p>
                  </div>
                  ...
                  <a rel="nofollow" data-toggle="tooltip" title="Download PDF Template"   href="<?= base_url() . "download/pdf/" . $details['pdfFile']; ?>" class="btn orangeBg" role="button">
                  	<i class="fa fa-file-pdf-o f-28"></i>  PDF
                    </a>
                     <a data-toggle="tooltip"  title="Download Word Template" rel="nofollw" href="<?= Assets . "images/office/word/" . $details['WordDoc']; ?>" class="btn blueBg" role="button">
                 		<i class="fa f-28 fa-file-word-o "></i> Word
                                                ...
                                                <div class="col-xs-12 text-left download-icons"><a rel="nofollow"
                                                            ...
                                                            data-toggle="tooltip" title="Download Word Template"
                                                            rel="nofollw"
                                                            href="<?= Assets . "images/office/word/" . $details['WordDoc']; ?>"
                                                            role="button"> <img
                                                                src="<?= Assets ?>images/word-icon.png"/> </a> <a
                                                            ...
                                                            role="button"> <img src="<?= Assets ?>images/ld-icon.png"/>
                                                    </a></div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <?php if ($compitable): ?>
                        <div class="row">
                            <div class="col-md-12">
                                <p class="m-t-b-8"><small><strong>Disclaimer: </strong>AALabels products are not made or
                                        endorsed by Avery®. Avery® is a trademark of CCL Industries Inc., registered in
                                        the UK and other countries. References to Avery® are solely used to indicate
        ...
        <div class="modal-content">
            ...
            <div>
                <div id="lb_applications_loader" class="white-screen hidden-xs" style="display:none;">
                    <div class="loading-gif text-center" style="top:26%;left:29%;"><img
                                src="<?= Assets ?>images/loader.gif" class="image" style="width:139px; height:29px; ">
                    </div>
                </div>
...
<script>
    ...
    $(document).on("click", ".productdetails .plain_calculation_unit li a", function (e) {
        ...
        if (selText == 'Labels') {
            var milabels = parseInt(labelspersheet * 25);
            ...
            $(this).parents('.productdetails').find('.plainsheet_input').attr('placeholder', 'Minimum 25 ');
            $(this).parents('.productdetails').find('.small_plain_minqty_txt').text('Minimum order 25 sheets');
    ...
    $(document).on("click", ".productdetails .print_calculation_unit li a", function (e) {
        ...
        if (selText == 'Labels') {
            ...
            $(this).parents('.productdetails').find('.printedsheet_input').attr('placeholder', 'Minimum 25 ');
            $(this).parents('.productdetails').find('.small_print_minqty_txt').text('Minimum order 25 sheets');
            qty = parseInt(qty / labelspersheet);
            if (qty > 24) {
                $(this).parents('.productdetails').find('.printedsheet_input').val(qty)
            } else {
