...
<div class="col-sm-6 col-xs-6  m-t-20 paymentdiv" style=" <?=(isset($sample) and $sample=='sample')?'display:none;':''?>" >
<div class="col-sm-12">
...
var sheet = window.document.styleSheets[0];sheet.insertRule('.mobileBody #_el_input_nameoncard input { width: 20%!important; }', sheet.cssRules.length);
                ...
                <? 
                               ...
                               <label class="cardsonfile select m-t-10" style="display:none; margin-bottom:0px;">
                                    <select name="creditcard" id="creditcard" class="required">
                                      <option  value="">Select your saved credit cards</option>
                                       ...
                                       <? } ?>
                                       <option value="not-on-file">Add a new card</option>
                                    </select>
                                    <i></i> 
                              </label>
						</div>
                   <div class="col-md-5">     
                     <label class="cvcinput input m-t-10" style="display:none; margin-bottom:0px;">
                        ...
                        <input type="text" size="4" placeholder="CVC Number" value="" id="cvcnumb"  class="required">
                    </label>
                  </div>  
                <div class="clear"></div>
          ...
          <div class="cardsonfile retain_card_opt m-l-10" style="display:none;">
                   <label class="checkbox pull-right" style=" position:absolute; margin-left:182px; margin-top:37px !important;" >
                        <input type="checkbox" value="0" name="retain_cards" id="retain_cards" class="textOrange"><i></i>
                   </label>
                   <p> Your card details are securely stored with Worldpay enabling future purchases. However if you would prefer not to have your card details retained please tick this box.</p> 
             </div>
           </div>  
              ...
              <div class="clear10"></div>
         			 <div class="col-sm-6 paymentInputs text-center">
                    	<img onerror='imgError(this);' src="<?=Assets?>images/godaddy-secure-ssl-seal.png" alt="" width="400" class="">
                     </div>
           ...
           <div class="col-sm-6 m-t-30">
                  ...
                  <div class="col-sm-12 paymentInputs normal_checkout m-t-30">
                         <div class="col-sm-12 " >
...
var Worldpay2 = Worldpay;
function worldPay(form){
	Worldpay2.useTemplateForm({
...
$(document).on("click", "#back_to_payment", function(e) {
	
	var creditcard  = $('#creditcard').val();
	if(typeof creditcard != 'undefined' && creditcard.length > 1){
		window.location.reload();
	}
	
	$('#previous_3').show();
	$('#back_to_payment').hide();
