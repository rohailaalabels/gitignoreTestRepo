          ...
          <div class="dropdown-menu mega-dropdown-menu">
            ...
            <div class="tab-content clearfix"> 
               ...
               <div role="tabpanel" class="tab-pane active" id="tc-2"> 
                ...
                <div class="col-sm-6 col-md-3 col-xs-6" nav-item-pos="ni-1-2-1"> 
                		<img src="<?=Assets?>images/icon-roll.png" class="img-responsive roll-icon-nav"/>
              ...
              <!-- Labels by Material -->
                ...
                <div class="plain_labels_section"> 
                  ...
                  <!-- Labels on Sheets -->
                  <div class="col-sm-6 col-md-6" nav-item-pos="ni-1-1-2"> 
                  ...
                  <div class="col-sm-6 col-md-6" nav-item-pos="ni-1-1-1"> 
                  <img src="<?=Assets?>images/icon-roll.png" class="img-responsive roll-icon-nav"/>
                    <h5>Labels on Rolls</h5>
                    <!-- Paper -->
                    <div class="row">
