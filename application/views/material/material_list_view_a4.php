...
<section data-mat-filters="<?=$materialinfo['filter_group']?>" data-reset="reset" data-promotion="<?=$promotion_filter?>">
  <div class="row productdetails" data-value="<?=$rec->ProductID?>" data-finish="<?=$rec->LabelFinish?>" data-material="<?=$rec->ColourMaterial?>" >
    <div class="hiddenfields" >
      ...
      <input type="text" value="0" data-qty="0"  id="uploadedartworks_<?=$rec->ProductID?>"  />
    ...
    <article class="col-lg-5 col-md-5 col-sm-12 col-xs-12 mat-detail">
      ...
      <div class="clear"></div>
      <div class="row specs">
        <div class="col-lg-3 col-md-3 col-sm-2 col-xs-3"> <img onerror='imgError(this);' class="img-responsive product_material_image" src="<?=$mat_image?>" > </div>
        <div class="col-lg-9 col-md-9 col-sm-10 col-xs-9">
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="row">
                <div class="col-md-6 col-sm-4 col-xs-6"> <a href="#" id="<?=$rec->ProductID?>" class="technical_specs" data-target=".material" data-toggle="modal" data-original-title="Technial Specification">Material Specification <i class="fa fa-info-circle"></i></a> </div>
                <div class="col-md-6 col-sm-4 col-xs-6"> <a href="#" id="<?=$group_name?>" class="applications" data-target=".lb_applications" data-toggle="modal" data-original-title="Tecnial Specification">Label Applications <i class="fa fa-table" aria-hidden="true"></i> </a> </div>
              </div>
            </div>
          </div>
          <div class="clear10"></div>
          <ul class="clr-thumbs colourpicker">
            ...
            <li class="<?=$active_colour?> data-reset-colour" data-toggle="tooltip" data-placement="bottom" 
                          ...
                          data-original-title="<?=$row->colour_name?>" data-colour-filters="<?=$row->LabelColor?>"  > <a class="mat_<?=$colourclass?>" data-value="<?=$row->LabelColor?>" href="javascript:void(0);"> <img onerror='imgError(this);' class="img-responsive" src="<?=$colour_icon?>" alt="<?=$row->colour_name?>"></a> </li>
            <? } ?>
          </ul>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 comp">
          <table class="table printer" border="0" style="border:none;">
            <tbody>
              <tr>
                <td align="left" valign="center" style="font-size:12px; border:none;vertical-align: bottom;width:40%;"><?php  if($rec->EuroID)
				 {
					 $euro_class = "show";
				 }
				 else
				 ...
				 ?>
                  <div class="price_promise_div printer_edge <?=$euro_class?>">
                    <h5><a data-toggle="tooltip-product" data-html="true" data-placement="top" class="" title="" data-original-title="Dry edge A4 sheet labels for faster problem free printing.<br/><br/> All our label sheets are subject to QA inspection to ensure printer compatibility and performance, but the removal of the edge strip on our Dry Edge sheets significantly reduces the risks of problems associated with adhesive leaching." href="javascript:void(0);"> <img onerror='imgError(this);' src="<?=Assets?>images/check-circle.png" class="circle-icon">Dry Edge<br>
                      <span>Product</span><i class="fa fa-info-circle"></i></a></h5>
                  </div>
                  
                  <!--<small style="margin-top:10px;font-size:12px;">Printer Compatibility</small>--></td>
                ...
                <td  align="left" style=" font-size:12px;border:none;width:25%;visibility:hidden;display:none;"> Direct<br />
                  ...
                  <img onerror='imgError(this);' class="direct_printer_img" width="50" src="<?=Assets?>images/<?=$comp['d_thermal_img']?>"  />--></td>
                <td align="left" style=" font-size:12px;border:none;width:25%; visibility:hidden"><!--Thermal<br />
                  ...
                  <img onerror='imgError(this);' class="thermal_printer_img" width="50" src="<?=Assets?>images/<?=$comp['thermal_img']?>"  />--></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div id="tab_plain<?=$rec->ProductID?>" class="tab-pane tabplain active" role="tabpanel">
          ...
          <div class="row" style="margin-top: 50px;">
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center qty">
                  <div class="input-group">
                    <input class="form-control text-center allownumeric plainsheet_input" data-toggle="popover" data-content="" placeholder="Enter Sheets" type="text">
                    <div class="input-group-btn">
                      <button type="button" class="btn btn-default dropdown-toggle plainsheet_unit" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sheets <span class="caret"></span></button>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 quotation"> 
              ...
              <div class="price_promise_div row">
                <div class="col-md-8 pull-right">
                  <h5><a data-toggle="tooltip-product" data-placement="top" class="" title="" data-original-title="If within 7 days of buying this Dry Edge product sheet from us, you find the same product cheaper to purchase online at any other UK label website, we will refund 100% of the difference." href="javascript:void(0);"> <img onerror='imgError(this);' src="<?=Assets?>images/check-circle.png" class="circle-icon"/>Lowest Prices<br />
                ...
                <table class="price" width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tbody>
                    ...
                    <tr class="halfprintprice" style="">
                      <td style=" width:80%;" class="text-right phead color-orange"><span class="percentage_discount">25</span>% Off Promotion</td>
                      <td style=" width:20%;" class="promotion_price color-orange text-right"></td>
                    </tr>
                    <tr>
                      <td colspan="2" class="text-right total"  style="border:none;"><div class="text-right plainprice_text priceplain">&nbsp;</div>
                        <div class="clear"></div></td>
                    </tr>
                    <tr>
                      <td colspan="2" class="text-right"><div class="plainperlabels_text"></div></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="col-xs-12 ofq">
              ...
              <div class="col-xs-4 main-box">
                <div class="row">
                  <div class="col-xs-2 no-padding-right ofq-icon"><img onerror='imgError(this);' src="<?=Assets?>images/check-circle.png" class="circle-icon-small"/></div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 quotation"> 
              ...
              <div class="price_promise_div row">
                <div class="col-md-8 col-sm-8 pull-right">
                  <h5><a data-toggle="tooltip-product" data-placement="top" class="" title="" data-original-title="<?=$tooltip_msg?>" href="javascript:void(0);"> <img onerror='imgError(this);' src="<?=Assets?>images/check-circle.png" class="circle-icon"/>Lowest Prices<br />
                    <span>Guaranteed Online</span><i class="fa fa-info-circle"></i> </a></h5>
                </div>
              </div>
